...
]).push([['chunk-video'],
{
  ...
  d44d: function (e, t, i) {
    ...
    function T(e) {
      ...
      e.noAD || !P() ? r.a.resolve(t)  : (e = I(e), x(e.player, e).then(function (e) {
        if (t.data = e || {
    ...
    function D(e, t, i) {
      if (t <= 0) return r.a.reject(Error('auth fail'));
      e.k_err_retries = N - t;
      var n = z(e),
      a = e.callbackName;
      try {
  ...
  e185: function (e, t, i) {
    ...
    P = x,
    I = Object(f['a']) (P, C, T, !1, null, null, null),
    V = I.exports,
        ...
        info: function () {
          ...
          return e = this.isPano(t) ? {
           ...
           : [
            ...
            text: '很抱歉，<br>应版权方要求，当前节目只能在客户端观看',
            callAppText: '去爱奇艺APP观看'
          }
           : {
            text: '很抱歉<br>您所查看的视频不存在',
    ...
    Oe = $e,
    je = Object(f['a']) (Oe, Pe, Ie, !1, null, null, null),
    Le = je.exports,
    ...
    Pt = xt,
    It = Object(f['a']) (Pt, Ct, Tt, !1, null, null, null),
    Vt = It.exports,
    $t = function () {
      var e = this,
      t = e.$createElement,
    ...
    Et = {
      ...
      data: function () {
        return {
          ...
          progressRegulation: '',
          direction: 0,
          danmuSubtype: Lt['h'].danmu.subtype,
          videoInfo: {
          }
        }
      },
    ...
    Gt = {
      ...
      data: function () {
        return {
          ...
          loadingTipShow: !1,
          quailtyChange: '',
          loadingSubtype: Lt['h'].loading.subtype,
          videoInfo: {
          }
        }
      },
    ...
    ui = {
      ...
      computed: {
        ...
        subType: function () {
          return this.blackCondtionSubtype || di[this.videoInfo.cid || (this.videoInfo.data ? this.videoInfo.data.cid : '')] || this.subtype
        }
      },
      watch: {
        show: function (e) {
      ...
      methods: {
        ...
        redirectOrCallApp: function () {
          ...
          t = e.toCopy && !this.blackCondtionSubtype ? {
        ...
        blackCondtion: function () {
          var e = this,
          t = this.$GlobalSwitcher.getParams('source_limit', 'play');
          if (!t) return !1;
          var i = t.configs;
          if (!i || !i.length) return !1;
          var n = this.videoInfo.qipuId || this.videoInfo.tvid || this.videoInfo.id || '',
          a = this.videoInfo.aid || this.videoInfo.albumId || '',
          r = ni() || ai();
          return i.some(function (t) {
            ...
            u = o && o.indexOf(r) >= 0,
            l = (c || d) && u;
            return l && i && (e.blackCondtionSubtype = i),
            l
          })
        },
        ...
        startCondition: function () {
          return this.blackCondtion() || W.txTV || W.youku || W.xigua || W.toutiao
        },
      ...
      methods: {
        ...
        callApp: function () {
          ...
          return Object(Lt['y']) ({
            ...
            var e = t.downloadUrl || Object(Lt['m']) ({
              downAppPos: 'play_button_open'
            });
            return Object(Lt['k']) (e),
    ...
    Ii = {
      ...
      methods: {
        bindEvent: function () {
          ...
          t = this.$parent;
          t.on('playing', function () {
            e.startPlay && e.$parent.src() && (e.startPlay = !1, Object(Ve['g']) (), e.sendReadyVV()),
            e.checkRealVideoVV()
          }),
          t.on('pause', function () {
    ...
    Vi = Ii,
    $i = Object(f['a']) (Vi, xi, Pi, !1, null, null, null),
    Oi = $i.exports,
    ji = function () {
      var e = this,
      t = e.$createElement,
