...
]).push([['appP'],
{
  ...
  '23d5': function (e, t, n) {
    ...
    O = P,
    _ = n('2877'),
    k = Object(_['a']) (O, y, g, !1, null, null, null),
    j = k.exports,
    x = function () {
      var e = this,
      t = e.$createElement,
    ...
    q = C,
    U = Object(_['a']) (q, x, A, !1, null, null, null),
    B = U.exports,
    ...
    W = 'SHORT',
    G = (a = {
    }, Object(E['a']) (a, F, 'hotalbum'), Object(E['a']) (a, W, 'shortvideo'), a),
    H = {
      ...
      computed: Object(m['a']) ({
        ...
        tmpl: function () {
          return this.template.album || this.template.source ? F : this.template.short ? W : ''
        }
      }),
      watch: {
      ...
      methods: {
            ...
            return regeneratorRuntime.wrap(function (e) {
              while (1) switch (e.prev = e.next) {
                ...
                case 9:
                  ...
                  break;
                case 13:
                  i = Object(N['Q']) (this.getParams.bind(this), this.getFilters.bind(this), this.detect.bind(this), this.callapp.bind(this)),
                  i();
                case 15:
                case 'end':
                  return e.stop()
        ...
        getFilters: function (e) {
          ...
          s = function (e) {
            var t = e.platform;
            return !t || (t = $() (t), 1 !== t && 2 !== t || (1 !== t || !N['N'].ios) && (2 !== t || !N['N'].android))
          },
          c = function (e) {
            var t = e.proportion;
            if (!t) return !0;
            var n = z.slice(0, Math.floor(V() (t) * z.length));
    ...
    J = H,
    Y = Object(_['a']) (J, i, o, !1, null, null, null),
    Q = Y.exports,
    X = n('ab22'),
    Z = n('3e9e'),
    ee = function () {
    ...
    ne = {
      ...
      methods: {
        updateTitle: function () {
          var e = Object(X['p']) (this.subTemplate, this.videoInfo, this.albumInfo);
          e && (document.title = e)
        }
      }
    },
    ae = ne,
    ie = Object(_['a']) (ae, ee, te, !1, null, null, null),
    oe = ie.exports,
    re = function () {
      var e = this,
      t = e.$createElement,
    ...
    ue = ce,
    pe = Object(_['a']) (ue, re, le, !1, null, null, null),
    de = pe.exports,
    fe = n('b924'),
    me = 'play',
    he = {
      ...
      head: function () {
        ...
        return {
          ...
          ].concat(Object(f['a']) (Object(X['n']) ()), Object(f['a']) (Object(X['m']) ())),
          script: [
    ...
    be = he,
    ve = Object(_['a']) (be, r, l, !1, null, null, null);
