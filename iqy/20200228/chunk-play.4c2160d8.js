...
]).push([['chunk-play'],
{
              ...
              while (1) switch (e.prev = e.next) {
                ...
                case 6:
                  ...
                  a && a.items && (this.videos = a.items.length >= this.min ? a.items.slice(0, this.max)  : [
                    ...
                    return e.imageUrl = Object(c['v']) (e.imageUrl, n.imageSize),
  ...
  '0b00': function (e, t, i) {
          ...
          directives: [
            {
              ...
              expression: '{block: `${cover.prePingback}block`, bstp: 56, mcnt: \'qiyue_interact\'}'
            },
            {
              name: 'pingback',
              rawName: 'v-pingback',
              ...
              expression: '{rseat: `${cover.prePingback}rseat`, bstp: 56, mcnt: \'qiyue_interact\'}'
            }
          ],
          key: a,
          staticClass: 'm-iqylink-guide vip-marketing'
        }, [
          t.isUrl && t.detail.text1 && t.linkType && t.linkType.url ? i('a', {
            staticClass: 'c-btn c-btn-block',
              ...
              while (1) switch (e.prev = e.next) {
                ...
                case 5:
                  ...
                  n.success && n.covers && (n.covers.forEach(function (e) {
                    ...
                    e.linkType = e.detail && e.detail.linkType || {
                    },
    ...
    _ = C,
    k = Object(m['a']) (_, y, g, !1, null, null, null),
    x = k.exports,
    T = function () {
      var e = this,
      t = e.$createElement,
    ...
    N = {
      ...
      methods: {
        ...
        buySingle: function (e) {
          ...
          i = ''.concat(window.location.protocol, '//m.iqiyi.com/productPay.html?').concat(Object(O['stringify']) (t));
          ...
          var e = Object(r['a']) (regeneratorRuntime.mark(function e() {
            ...
            return regeneratorRuntime.wrap(function (e) {
              while (1) switch (e.prev = e.next) {
                case 0:
                  return e.next = 2,
                  S['a'].jsonp(Object(B['S']) (this.info.useVodCouponUrl)).catch (function () {
                    return {
                      data: {
                      }
                    }
    ...
    q = N,
    V = Object(m['a']) (q, T, P, !1, null, null, null),
    L = V.exports,
    E = i('4f30'),
    A = {
      name: 'PlayBanner',
      ...
      computed: Object(c['a']) ({
        ...
        isMovie: function () {
          return this.videoInfo.cid === + E['CHANNEL_DIANYING']
        },
      ...
      mounted: function () {
        ...
        this.$qiyiPlayer.$on('error', function () {
          e.checkType()
        })
      },
      methods: {
    ...
    R = A,
    $ = Object(m['a']) (R, a, n, !1, null, null, null);
    t['a'] = $.exports
  },
  1266: function (e, t, i) {
    'use strict';
    ...
    u = {
      ...
      computed: {
        subCountContent: function () {
          return this.count ? ''.concat(Object(r['w']) (this.count), '人 已预约')  : ''
        }
      },
      watch: {
  ...
  '17b0': function (e, t, i) {
    ...
    function k() {
      return k = Object(r['a']) (regeneratorRuntime.mark(function e(t, i) {
        ...
        return regeneratorRuntime.wrap(function (e) {
          while (1) switch (e.prev = e.next) {
            case 0:
              if (a = t.commit, s = t.state, r = i.pre, p = i.id, h = i.query, b = i.redirect, y = i.noUpdateUrl, g = i.url, w = void 0 === g ? '' : g, I = i.referrer, _ = void 0 === I ? '' : I, k = i.qipuId, x = void 0 === k ? '' : k, T = i.isAdvert, P = void 0 !== T && T, e.prev = 2, s.dataDone = !1, S = Object(m['u']) (this.$userAgent.userAgent || ''), O = S.browser, j = O && O.name ? {
                browser: O.name
              }
               : {
              }, B = {
            ...
            case 10:
              ...
              c['a'].jsonp(''.concat(u['m']).concat(r, '/').concat(p, '/'), {
                headers: {
                  ...
                  Referer: Object(f['a']) (_)
                },
                params: o() ({
                }, B, h, j)
              });
            case 12:
              if (N = e.sent, q = N.data, V = !(q && 'MS0001' === q.code), !V && v.log('isValid', V, 'data.code:', q.code), a('setError', !V), a('setRedirect', b), b && a('setValid', V), !q || 'A00000' !== q.code || !q.data) {
                e.next = 34;
                break
              }
              if (L = q.data, !y) {
              ...
              return e.abrupt('return', a('setLoadInfo', L.playVideoInfo));
            case 23:
              L.token && a('setSecureJsonpToken', L.token),
              a('setTemplate', {
                data: L,
                redirect: b
              }),
              a('setCallappConfigs', L.callAppConfigs),
              a('setDiversionInfo', L.diversionInfo),
              a('setControlInfo', {
                controlInfo: L.controlInfo,
                query: h
              }),
              a('setCollectionInfo', L),
              a('setRecommendQuery', L.recommendQuery && L.recommendQuery.data ? L.recommendQuery.data : {
              }),
              L.seoInfo && (s.seoInfo = L.seoInfo),
              b && (s.channelId = s.template.vertical && !s.template.bodan ? L.verticalVideoInfo.channelId : L.playVideoInfo.cid),
              s.template.vertical && !s.template.bodan ? (a('setVerticalVideo', L.verticalVideoInfo || L.playVideoInfo), a('setVideo', L.playVideoInfo), a('setAlbum', L.playAlbumInfo), a('setLoadInfo', L.playVideoInfo))  : (L.verticalVideoInfo && a('setVerticalVideo', L.verticalVideoInfo), a('setLoadInfo', L.playVideoInfo), a('setVideo', L.playVideoInfo), a('setVipTag', L.vipTag), a('setAlbum', L.playAlbumInfo), a('setUser', L.playUserInfo), a('setPlayList', L.playList), b && (L.videoList && (E = Object(d['o']) (L.playAlbumInfo), L.videoList.updateInfo = E, a('setVideoList', L.videoList)), a('setPlayerBanner', L.playerBanner))),
              s.dataDone = !0;
            case 34:
              return e.abrupt('return', q.data);
            case 37:
              e.prev = 37,
              e.t0 = e['catch'](2),
              v.error({
    ...
    function D(e, t) {
      ...
      if (e.superTemplate.horizontal = n === b, e.superTemplate.vertical = n === g, e.superTemplate.wechat = n === y, e.superTemplate.knowledge = n === w, e.subTemplate = Object(d['t']) (i.playVideoInfo), a) {
    ...
    function Q(e, t) {
      t && (t.checking = I.includes(t.checkState), e.verticalVideoInfo = t, e.verticalErrCode = !t.qipuId || null)
    }
    function K(e, t) {
      e.verticalVideoInfo.errCode = t,
      e.verticalVideoInfo = o() ({
      }, e.verticalVideoInfo)
    }
    function z(e, t) {
      e.layerOpen = t
  ...
  '4de8': function (e, t, i) {
    ...
    V = q,
    L = Object(v['a']) (V, a, n, !1, null, null, null);
    t['a'] = L.exports
  },
  '4e08': function (e, t, i) {
    'use strict';
  ...
  '6f42': function (e, t, i) {
    ...
    I = w,
    C = i('2877'),
    _ = Object(C['a']) (I, n, s, !1, null, null, null);
    t['a'] = _.exports
  },
  '70a9': function (e, t, i) {
    'use strict';
    ...
    d = function () {
      ...
      return i('div', {
        ...
        i('div', {
          ...
          e._v('内容热度是客观反映内容当前受欢迎程度的指标。内容热度基于海量用户行为数据，通过当前用户观看行为数据、视频互动行为（包含评论、弹幕、泡泡等互动行为数据）等指标，综合评估用户对内容的反馈情况，进而衡量内容本身的质量和当前受欢迎程度。')
        ]),
        i('div', {
          staticClass: 'c-stitle'
        }, [
    ...
    I = w,
    C = Object(m['a']) (I, y, g, !1, null, null, null),
    _ = C.exports,
    k = i('ab22'),
    x = i('45bc'),
    T = {
    ...
    P = T,
    S = (i('27f4'), Object(m['a']) (P, c, l, !1, null, '52499120', null)),
    O = S.exports,
    j = {
      name: 'PlayHotLayer',
      components: {
  ...
  '7b03': function (e, t, i) {
            ...
            return regeneratorRuntime.wrap(function (e) {
              while (1) switch (e.prev = e.next) {
                ...
                case 6:
                  ...
                  e.abrupt('return', this.show && 'sub' === this.type);
                case 13:
                case 'end':
                  return e.stop()
              }
    ...
    I = w,
    C = Object(f['a']) (I, b, y, !1, null, null, null),
    _ = C.exports,
    k = function () {
      var e = this,
      t = e.$createElement,
      ...
      return i('div', {
        staticClass: 'm-videoUser-spacing',
        class : e.boxItemClass
      }, [
        i('div', {
          staticClass: 'm-videoUser-spacingBox'
        }, e._l(e.ipItems, function (t) {
          return i('div', {
            directives: [
              {
                name: 'pingback',
            ...
            key: e.videoInfo.qipuId + '_' + t.rec_id + '_' + t.index,
            staticClass: 'm-videoUser-spacingItem'
          }, [
            i('a', {
              staticClass: 'videoUser-data',
              ...
              i('div', {
                ...
                i('div', {
                  ...
                  i('i', {
                    staticClass: 'c-picicon-s',
                    class : e.typeConfig[t.type].iconClass
                  })
                ])
              ]),
              i('div', {
            ...
            1 === e.ipItems.length ? i('a', {
              ...
              i('span', {
                ...
                e._v(e._s(e.typeConfig[t.type].buttonText))
              ])
            ])  : e._e()
          ])
        }), 0)
    ...
    T = (i('4f37'), i('d25f'), i('6d67'), i('a4bb')),
    P = i.n(T),
    S = i('936f'),
    O = i('8296'),
    j = '//pub.m.iqiyi.com/h5/main/rec/ip/',
    B = {
      ANDROID: 1510,
      IOS: 1512
    };
    ...
    function q() {
      return q = Object(s['a']) (regeneratorRuntime.mark(function e() {
        var t,
        i,
        a,
        n = arguments;
        return regeneratorRuntime.wrap(function (e) {
          while (1) switch (e.prev = e.next) {
            case 0:
              ...
              S['a'].jsonpCache(j, {
                params: {
                  rec_id: t.rec_id,
                  cid: t.cid,
                  p1: O['N'].android ? B.ANDROID : B.IOS
                }
              }).catch (function (e) {
                return {
                  data: {
            ...
            case 3:
              return i = e.sent,
              a = i.data,
              e.abrupt('return', 'A00000' === a.code && a.data && a.data.recItems ? a.data : {
              });
            case 6:
            case 'end':
              return e.stop()
    ...
    var V = {
      ...
      data: function () {
        return {
          ...
          typeConfig: {
            knowledge: {
              iconClass: 'c-picicon-zs',
              buttonText: '涨知识'
            },
            book: {
              iconClass: 'c-picicon-wenxue',
              buttonText: '立即阅读'
            },
            game: {
              iconClass: 'c-picicon-game',
              buttonText: '开始游戏'
            }
          }
        }
      ...
      computed: Object(o['a']) ({
        ...
        boxItemClass: function () {
          var e = this.ipItems.length;
          return e > 2 ? 'm-videoUserSpace-twoSliding' : 2 === e ? 'm-videoUserSpace-two' : ''
        },
        supportType: function () {
          return P() (this.typeConfig)
        },
        pingbackParams: function () {
          return {
            r_eventid: this.pingback.event_id,
            ip_summary: this.ipId,
            qpid: this.videoInfo.qipuId,
      ...
      methods: {
            ...
            return regeneratorRuntime.wrap(function (e) {
              while (1) switch (e.prev = e.next) {
                case 0:
                  return e.next = 2,
                  N({
                    rec_id: this.videoInfo.qipuId,
                    cid: this.videoInfo.cid
                  });
                case 2:
                  return t = e.sent,
                  this.ipId = t.ipId || '',
                  this.pingback = t.pingback || '',
                  this.ipItems = this.formatIpItems(t.recItems || [
                  ]),
                  e.abrupt('return', this.ipItems && this.ipItems.length);
                case 7:
                case 'end':
                  return e.stop()
              }
        ...
        formatIpItems: function (e) {
          var t = this;
          return e.filter(function (e) {
            return t.supportType.includes(e.type)
          }).map(function (i, a) {
            return i.description && (i.description = i.description.trim()),
            'game' === i.type && (i.page_url = O['k'].addQuery(i.page_url, {
              h5_serverid: 'miqiyiip'
            })),
            i.index = a,
            i.block = Object(o['a']) ({
              block: '701051_ipgl_'.concat(e.length, '_').concat(a),
              adcrid: i.rec_id,
              f_sid: i.type_id
            }, t.pingbackParams),
            i.rseat = Object(o['a']) ({
    ...
    L = V,
    E = Object(f['a']) (L, k, x, !1, null, null, null),
    A = E.exports,
    R = i('4e08'),
    $ = function () {
      var e = this,
    ...
    U = Object(f['a']) (H, $, D, !1, null, null, null),
    F = U.exports,
    M = {
          ...
          var e = Object(s['a']) (regeneratorRuntime.mark(function e() {
            ...
            return regeneratorRuntime.wrap(function (e) {
              while (1) switch (e.prev = e.next) {
                ...
                case 20:
                  this.enable.adOrigin && (this.card = 'adOrigin');
                case 21:
                case 'end':
                  return e.stop()
              }
    ...
    Q = M,
    K = Object(f['a']) (Q, a, n, !1, null, null, null);
    t['a'] = K.exports
  },
  8642: function (e, t, i) {
    'use strict';
    ...
    t['a'] = {
      ...
      computed: Object(a['a']) ({
        ...
        count: function () {
          return this.comment ? Object(o['o']) (this.comment.commentCount)  : 0
        },
        isShow: function () {
  ...
  '985e': function (e, t, i) {
          ...
          var e = Object(o['a']) (regeneratorRuntime.mark(function e() {
            ...
            return regeneratorRuntime.wrap(function (e) {
              while (1) switch (e.prev = e.next) {
                ...
                case 3:
                  i = e.sent,
                  i.success ? (this.onCancelSuccess(), this.showToast('已取消收藏'), Object(c['g']) ({
                ...
                while (1) switch (e.prev = e.next) {
                  ...
                  case 3:
                    ...
                    i && i.length && i.forEach(function (e) {
                      '片段' === e.upperRightCorner ? (e.lowerRightCorner = c['t'].formatTime(e.lowerRightCorner), e.upperRightCorner = '')  : '合集' === e.upperRightCorner && (e.lowerRightCorner = ''.concat(e.lowerRightCorner, '个片段')),
                      e.imageUrl = Object(c['v']) (e.imageUrl, '480_270'),
    ...
    '9f66': function (e, t, i) {
      ...
      b = {
        ...
        methods: {
          ...
          toggleshowScore: function () {
            this.isLogin ? (this.isShowScore = !this.isShowScore, Object(v['g']) ({
              rseat: '605091_score'
            }))  : (location.href = '/user.html', Object(v['g']) ({
              rseat: '705232_score0'
            }))
          },
      ...
      _ = C,
      k = Object(g['a']) (_, a, n, !1, null, null, null);
      t['a'] = k.exports
    },
    a09a: function (e, t, i) {
      'use strict';
    ...
    aed2: function (e, t, i) {
      ...
      C = I,
      _ = Object(b['a']) (C, a, n, !1, null, null, null);
      t['a'] = _.exports
    },
    b65b: function (e, t, i) {
      'use strict';
    ...
    b75f: function (e, t, i) {
        ...
        return i('div', {
          ...
          i('QiyiPlayer', e._b({
            ...
            attrs: {
              ...
              fatherid: e.fatherId,
              rate: e.currentRate,
              'purchase-type': e.loadInfo.purchaseType,
              'ad-params': e.adParams,
              autoplay: e.autoPlay,
            ...
            on: {
              loaded: e.loaded,
              created: e.created,
              authReady: e.onAuthReady,
              playStart: e.onPlayStart,
              playEnd: e.onPlayEnd,
              play: e.onPlay,
              pause: e.onPause,
              recharge: e.onRecharge,
              loaddone: e.canPreload,
              ...
              sendVV: e.onSendVV,
              waiting: e.onWaiting,
              rateSwitched: e.rateSwitched,
              hidePlayer: e.hidePlayerHandle,
              src: e.onVideoReady,
      ...
      I = {
        ...
        computed: Object(c['a']) ({
          ...
          callAppRateList: function () {
            ...
            return g['N'].ios || g['p'].vivo || e.push({
              isCallApp: !0,
              name: 'APP超清',
        ...
        watch: {
          ...
          currentBid: function (e, t) {
            e !== t && (this.currentRate = Object(y['b']) (e))
          }
        },
        mounted: function () {
          this.checkVip(),
          this.currentRate = Object(y['b']) (this.currentBid)
        },
        methods: {
      ...
      C = I,
      _ = i('2877'),
      k = Object(_['a']) (C, d, p, !1, null, null, null),
      x = k.exports,
      T = i('0578'),
      P = i('8a88'),
      S = i('703e'),
      ...
      L = V,
      E = Object(_['a']) (L, j, B, !1, null, null, null),
      A = E.exports,
      R = i('3e9e'),
      $ = i('5321'),
      D = i('f191'),
      ...
      Z = {
        ...
        components: {
          ...
          VideoLayerNetwork: S['a'],
          PlayVideoQuailty: x,
          VideoLayerDefaultError: O['a']
        },
        props: {
          playStyle: {
            type: String,
        ...
        data: function () {
          return {
            ...
            autoPlay: g['N'].android && (g['p'].qq || g['p'].miuibrowser || g['p'].oppobrowser) && !g['p'].weixin,
            currentBid: 200,
            bidList: [
            ],
            isTrivalPlaying: !1,
        ...
        computed: Object(c['a']) ({
          ...
          currentRate: function () {
            var e = Object(y['b']) (this.currentBid);
            return e && e.rate
          },
          adParams: function () {
            return {
        ...
        watch: {
          'loadInfo.qipuId': function (e, t) {
            this.loadInfo.qipuId && this.load()
          }
        },
        created: function () {
          g['L'].setItem('QiyiPlayerVD', this.currentRate)
        },
        mounted: function () {
          H['default'].prototype.$qiyiPlayer = this.$refs.player,
          Object(N['c']) (function (e) {
            J.log('orientationchange', e.portrait ? 'portrait' : 'landscape')
          }),
          window.addEventListener('unload', W['a']),
          this.cookieId = this.$cookies.get('P00002') || this.$cookies.get('QC006')
        },
        destroyed: function () {
          J.log('videoRelated com destroyed curTime', this.$qiyiPlayer.currentTime()),
          Object(N['g']) (this.onPageActiveBound),
          Object(W['a']) (),
          this.$refs.player && this.$refs.player.destroy()
        },
        methods: {
          created: function (e) {
            J.log(':::created'),
            ...
            this.polyFill = new z(e),
            g['V'].setItem('isSwitch', '1')
          },
              ...
              return regeneratorRuntime.wrap(function (e) {
                while (1) switch (e.prev = e.next) {
                  ...
                  case 3:
                    ...
                    this.curVideo = i,
                    this.showTitle = !!i.player && i.player.title,
                    this.pingbackParams = Object($['b']) (),
                    a = this.videoParams(),
                    n = this.vvParams(),
                    e.abrupt('return', this.$refs.player.afterAuth(Object(c['a']) ({
                      vfrmblk: i.vfrmblk,
                      vfrmrst: i.vfrmrst
                    }, a, n)));
                  case 11:
          ...
          loaded: function (e) {
            ...
            J.log('loaded', {
              dashCode: e.videoInfo.code + '-' + e.videoInfo.data.st,
              bossCode: e.videoInfo.data.boss_ts.code,
              prv: !!e.videoInfo.prv,
              vipType: this.vipType,
              isHttpEngine: t.isHttp,
          ...
          load: function () {
            this.$refs.player.loadSource(this.videoParams())
          },
          videoParams: function () {
            var e = Object(D['b']) (this.videoInfo, this.playTemplate, this.limitFilter);
            return {
              tvid: this.loadInfo.qipuId,
              fstply: g['V'].getItem('isSwitch'),
          ...
          vvParams: function () {
            var e = r() (Object(G['a']) ()) && (Object(G['a']) ().pop() || {
            }),
            t = Object(W['b']) () || {
            },
            i = e.block || '',
          ...
          onPlayEnd: function (e) {
            ...
            i = e.end,
            a = e.prv;
            if (J.log('playEnd'), this.isEnd = i, i && !a && !this.adInfoFeed.show && (R['a'].next(), !this.subTemplate.movie && !this.template.bodan)) {
              var n = R['a'].getCurVideo(),
              s = R['a'].getNextVideo(n);
          ...
          canPreload: function () {
            if (this.isVideo && !this.isTrivalPlaying && !this.adInfoFeed.show) {
              var e = R['a'].getNextVideo(this.curVideo);
              e && e.qipuId && (J.log('preload'), this.qiyiVideo.preload({
                tvid: e.qipuId,
                vid: e.vid
              }))
            }
          ...
          onPlay: function () {
            J.log('play', this.$refs.player.currentTime()),
            this.enableFix = !!g['N'].ios,
            this.$refs.player.show()
          },
          onPause: function () {
            J.log('pause', this.$refs.player.currentTime(), '；readystate:', this.$refs.player.getReadyState())
          },
          onRecharge: function () {
            J.log('recharge')
          },
          onSeeked: function () {
            J.log('seeked', this.$refs.player.currentTime()),
            this.logBuffer()
          },
          onPlayBtnClick: function () {
            this.isPlayBtnClicked || (J.log('playBtnClicked'), this.isPlayBtnClicked = !0)
          },
          onSendVV: function (e) {
            X.log('vv', 'currentTime:', this.$refs.player.currentTime(), e)
          },
          onWaiting: function () {
            J.log('video waiting'),
            this.logBuffer()
          ...
          logBuffer: function () {
            ...
            e - t < 2 && J.log('currentTime:', t, 'buffered: '.concat(e))
          },
          getAdId: function () {
            var e = R['a'].getCurVideo(),
            t = e ? e.source : {
            },
            i = t && t.noAD ? Y['b'] : '';
            return i || (g['p'].weixin ? 'qc_105092_300415' : this.adId)
          },
          toggleRateUpdate: function (e, t) {
            this.$refs.player.paused() && this.$refs.player.play(),
            this.sendVVPingback(e, t),
            this.oldRateInfo = e,
            this.rateInfo = t,
            J.log('qualityChange', this.quailtyChange),
            this.$refs.player.switchRate(t.rate)
          },
          rateSwitched: function (e) {
            var t = this,
            i = this.rateInfo.name;
            e.success ? (this.quailtyChange = i, J.log('qualityChanged done', this.quailtyChange))  : (this.quailtyChange = ''.concat(i, ' 失败'), this.currentBid = y['f'][this.oldRateInfo.rate], J.log('qualityChanged fail, target rate: ', i)),
            setTimeout(function () {
              t.quailtyChange = ''
            }, 3000)
          },
          ...
          onPageActive: function (e) {
            !this.limitShow && this.playFocus && (!e.active && !this.isFullscreen || this.adInfoFeed.show ? this.$refs.player.pause()  : this.$refs.player.play())
          },
          videoStatusChangeHandle: function (e) {
            J.log('videoStatusChange', e ? 'VIDEO' : 'AD'),
            this.isVideo = e,
          ...
          sourceTypeChangeHandle: function (e) {
            ...
            this.isFullscreen && this.hasErrorTip && (this.$refs.player.exitFullscreen(), J.log('exitfullscrren: source type !=0'))
          },
          removeSrc: function () {
          ...
          sourceVipTypeHandle: function (e) {
            e && e.layerInfo && J.log('vipLayerInfo', e),
          ...
          errorHandle: function (e) {
            if (e) {
              ...
              i = e.msg || '';
              if ('api' === t && (this.sdkError = !0), 'VIDEO' !== t || !this.$refs.player || '' !== this.$refs.player.src()) {
                var a = e.target && e.target.error ? e.target.error : e;
                J.error({
                  target: t,
                  message: a.message || i,
                  code: a.code ? ''.concat(a.constructor.name, ' ').concat(a.code)  : '',
                  stack: a.stack,
                  ec: g['c'],
                  error: a
                }),
                Object($['g']) ({
                  rseat: 'error_h5',
                  mcnt: encodeURIComponent('error of '.concat(t, ', msg: ').concat(i, ', ').concat(a.constructor.name || a.code || a.message || ''))
                })
              }
            }
          },
          fullscreenchangeHandle: function (e) {
            ...
            J.log('fullscreenchange', e.isFullscreen ? 'enter' : 'exit'),
            !this.isEnd && this.$qiyiPlayer.paused() && this.$qiyiPlayer.play()
          },
          hidePlayerHandle: function () {
            J.log('hide player element')
          },
          limitShowHandle: function (e) {
            J.log('limitLayer', e ? 'show' : 'hide'),
            this.limitShow = e
          },
      ...
      ee = Z,
      te = Object(_['a']) (ee, a, n, !1, null, null, null);
      t['a'] = te.exports
    },
    b771: function (e, t, i) {
      'use strict';
              ...
              e('a', {
                ...
                e('div', {
                  ...
                  e('div', {
                    ...
                    Object(m['w']) (t.memberCount),
                    '圈友'
                  ]),
                  e('div', {
                    class : 'c-des'
                  }, [
                    Object(m['w']) (t.feedCount),
                    '剧情讨论'
                  ])
                ]),
                e('span', {
    ...
    cf20: function (e, t, i) {
      ...
      p = {
        ...
        computed: Object(r['a']) ({
          ...
          isInteraction: function () {
            return 1 === o() (this.videoInfo.interactionType)
          },
          toPage: function () {
            return this.isInteraction ? u['e'] : this.isToHot ? u['d'] : this.isVertical ? u['g'] : u['f']
          },
          extralOptions: function () {
            return Object(d['i']) ({
      ...
      h = p,
      f = i('2877'),
      m = Object(f['a']) (h, a, n, !1, null, null, null);
      t['a'] = m.exports
    },
    cfb9: function (e, t, i) {
      'use strict';
      ...
      O = S,
      j = Object(v['a']) (O, a, n, !1, null, null, null),
      B = j.exports,
      N = function () {
        var e = this,
        t = e.$createElement,
      ...
      V = {
        ...
        brforeMount: function () {
          this.isWechat = l['p'].weixin
        }
      },
      L = V,
      E = Object(v['a']) (L, N, q, !1, null, null, null),
      A = E.exports,
      R = function () {
        var e = this,
        t = e.$createElement,
      ...
      H = D,
      U = Object(v['a']) (H, R, $, !1, null, null, null),
      F = U.exports,
      M = function () {
        var e = this,
        t = e.$createElement,
      ...
      G = {
        ...
        methods: {
          report: function () {
            ...
            window.location.href = '/m5/feedback/videoReport.html?'.concat(z.a.stringify(t))
          }
        }
      },
      W = G,
      ...
      ye = {
        ...
        methods: {
          ...
          wechatFriend: function () {
            ...
            l['p'].weixin ? this.showToast('weixin')  : (this.showToast('browser'), this.share.shareToWeixin())
          },
          wechatCirlce: function () {
            this.sendPingback('8', '171127_shrwei2'),
            l['p'].weixin ? this.showToast('weixin')  : (this.showToast('browser'), this.share.shareToWXFriends())
          },
          qqFriend: function () {
            this.sendPingback('6', '171127_shrqq1'),
            l['p'].weixin ? this.showToast('weixin')  : (this.showToast('browser'), this.share.shareToQQ())
          },
          qqZone: function () {
      ...
      xe = ke,
      Te = Object(v['a']) (xe, Ce, _e, !1, null, null, null),
      Pe = Te.exports,
      Se = function () {
        var e = this,
        t = e.$createElement,
      ...
      Be = je,
      Ne = Object(v['a']) (Be, Se, Oe, !1, null, null, null),
      qe = Ne.exports,
      Ve = function () {
        var e = this,
        t = e.$createElement,
      ...
      Ae = Ee,
      Re = Object(v['a']) (Ae, Ve, Le, !1, null, null, null),
      $e = Re.exports,
      De = function () {
        var e = this,
        t = e.$createElement,
      ...
      Fe = Ue,
      Me = Object(v['a']) (Fe, De, He, !1, null, null, null),
      Qe = Me.exports,
      Ke = function () {
        var e = this,
        t = e.$createElement,
      ...
      We = Ge,
      Ye = Object(v['a']) (We, Ke, ze, !1, null, null, null),
      Je = Ye.exports,
      Xe = function () {
        var e = this,
        t = e.$createElement,
    ...
    fb20: function (e, t, i) {
      ...
      c = {
        ...
        methods: {
          refreshHot: function () {
            this.params.qipuId && (this.hot || Object(o['r']) ({
          ...
          update: function (e) {
            ...
            this.$emit('showHot', !0),
            this.hotDisplay = Object(r['w']) (this.hotNum)
          }
        }
      },
      l = c,
