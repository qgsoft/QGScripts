...
function (t, exports) {
  ...
  e.prototype.emit = function (t) {
    ...
    if (i(n)) switch (arguments.length) {
      ...
      default:
        ...
        n.apply(this, r)
    } else if (s(n)) for (r = Array.prototype.slice.call(arguments, 1), u = n.slice(), o = u.length, l = 0; l < o; l++) u[l].apply(this, r);
    return !0
  },
  e.prototype.addListener = function (t, n) {
    ...
    this._events[t] ? s(this._events[t]) ? this._events[t].push(n)  : this._events[t] = [
      this._events[t],
      n
    ] : this._events[t] = n,
    s(this._events[t]) && !this._events[t].warned && (o = a(this._maxListeners) ? e.defaultMaxListeners : this._maxListeners, o && o > 0 && this._events[t].length > o && (this._events[t].warned = !0, console.error('(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.', this._events[t].length), 'function' == typeof console.trace && console.trace())),
    this
  },
  ...
  e.prototype.removeListener = function (t, e) {
    ...
    if (n = this._events[t], o = n.length, a = - 1, n === e || i(n.listener) && n.listener === e) delete this._events[t],
    this._events.removeListener && this.emit('removeListener', t, e);
     else if (s(n)) {
      for (r = o; r-- > 0; ) if (n[r] === e || n[r].listener && n[r].listener === e) {
        a = r;
        break
      }
      if (a < 0) return this;
      1 === n.length ? (n.length = 0, delete this._events[t])  : n.splice(a, 1),
      this._events.removeListener && this.emit('removeListener', t, e)
    }
    return this
  },
...
function (t, exports) {
  ...
  function e(t, e) {
    for (var i = '', n = [
    ], s = 0; s < t.length; s++) if (n = t[s].reg.exec(e)) {
      i = t[s];
      break
    }
    return n || (n = [
  ...
  function i() {
    ...
    d.browser && (exports.browser.name = o.name.toLowerCase(), exports.browser['is' + o.name] = !0, exports.browser.version = d.version, exports.browser.versionNumber = parseInt(d.version, 10)),
    d.platform && (exports.browser['is' + u.name] = !0, exports.browser.platform = u.name.toLowerCase()),
    ...
    return h.length > 0 && (exports.browser.isWindVane = !0, exports.browser.windVaneVersion = h[2]),
    exports.browser
  }
...
function (t, exports, e) {
  ...
  c = e(13),
  f = i(c);
  window.Promise || (window.Promise = d.default); var p = {
    TAG: 'util',
    jsopInfo: {
    },
    ckeyTimestamp: 0,
    ...
    sendlog: function (t, e) {
      ...
      i.src = t + '&r_=' + Math.floor(10000 * Math.random())
    },
    loadfile: function (t, e) {
      var i = null;
      'js' == e ? (i = document.createElement('script'), i.setAttribute('type', 'text/javascript'), i.setAttribute('src', t))  : 'css' == e && (i = document.createElement('link'), i.setAttribute('rel', 'stylesheet'), i.setAttribute('type', 'text/css'), i.setAttribute('href', t)),
    ...
    getJsonp: function (t, e, i, n, s) {
      ...
      window[u] = function (t) {
        d[r] && (clearTimeout(d[r]), delete d[r], e(t.data), document.getElementsByTagName('head') [0].removeChild(l), delete window[u])
      },
      o += '&callback=' + u,
      l.src = o,
    ...
    fetchrequest: function (t, e, i, s, a) {
      ...
      fetch(t, {
        ...
        var jds = t.substr(12,t.length-13);
        var jd = JSON.parse(jds);
        e && e(jd.data)
      }).catch (function (n) {
        if (n && n.response) n.code = n.response.status,
    ...
    decode64: function (t) {
      ...
      for (o = t.length, a = 0, r = ''; a < o; ) {
        do e = l[255 & t.charCodeAt(a++)];
        while (a < o && e == - 1);
        if (e == - 1) break;
        do i = l[255 & t.charCodeAt(a++)];
        while (a < o && i == - 1);
        if (i == - 1) break;
    ...
    rc4: function (t, e) {
      for (var i = [
      ], n = 0, s = void 0, a = '', o = 0; o < 256; o++) i[o] = o;
      for (o = 0; o < 256; o++) n = (n + i[o] + t.charCodeAt(o % t.length)) % 256,
      s = i[o],
      i[o] = i[n],
      i[n] = s;
      o = 0,
      n = 0;
      for (var r = 0; r < e.length; r++) o = (o + 1) % 256,
      n = (n + i[o]) % 256,
      s = i[o],
      i[o] = i[n],
      i[n] = s,
    ...
    cookie: {
      ...
      getCookie: function (t, e) {
        try {
          ...
          a.default.w(this.TAG, 'document.cookie is excption'),
          null
        }
      },
      setCookie: function (t, e, i) {
        try {
          ...
          null === e && (e = '', i.expires = - 1);
          var n = '';
          if (i.expires && ('number' == typeof i.expires || i.expires.toUTCString)) {
            var s = void 0;
            'number' == typeof i.expires ? (s = new Date, s.setTime(s.getTime() + 24 * i.expires * 60 * 60 * 1000))  : s = i.expires,
    ...
    show: function (t, e) {
      if (e = e || 'block', t instanceof Array) for (var i = 0, n = t.length; i < n; i++) {
        var s = t[i];
    ...
    hide: function (t) {
      if (t instanceof Array) for (var e = 0, i = t.length; e < i; e++) {
        var n = t[e];
    ...
    initUA_OPT: function () {
      if (!window.UA_Opt) {
        ...
        p.ckeyTimer || (p.ckeyTimer = window.setTimeout(function () {
      ...
      if (window.UA_Opt.callback = function () {
        window.clearTimeout(p.ckeyTimer),
        p.ckeyTimer = null,
        p.sendUALog((new Date).getTime() - p.ckeyTimestamp),
        p.ckey = window[window.UA_Opt.LogVal]
    ...
    sendUALog: function (t) {
      t = t < 100 ? 100 : t < 1000 ? 100 * parseInt(t / 100)  : t > 3000 ? 3000 : 1000 * parseInt(t / 1000);
      try {
        window.goldlog.record('/yt/youkuplayer.fdl.playerckey', 'EXP', 'verison=' + r.default.version + '&ccode=0501&millisecond=' + t + '&cna=' + p.cna,
        'GET')
      } catch (e) {
        p.sendlog('//gm.mmstat.com/yt/youkuplayer.fdl.playerckey?verison=' + r.default.version + '&ccode=0501&millisecond=' + t + '&cna=' + p.cna + '&t=' + (new Date).getTime())
      }
    },
    setBetaUrl: function (t) {
      var e = '',
      i = '';
      if (t) return p.m3u8test = t.beta && t.beta.m3u8 ? t.beta.m3u8 : null,
      void (p.m3u8test = t.beta && t.beta.ups ? t.beta.ups : null);
      var n = location.href;
...
function (t, exports, e) {
  ...
  U = function () {
    function t(e, i) {
      ...
      if (this.util = h.default,
      this.initTime = (new Date).getTime(),
      'string' == typeof e && h.default.getById(e)) this.containerId = e,
      ...
      if (a.vid = i.videoId || '', a.ccode = i.ccode, a.client_ip = '0.0.0.0', a.app_ver = '1.0.0', this.config.param) for (var o in this.config.param) this.config.param[o] && (a[o] = this.config.param[o]);
      a.client_ts = parseInt((new Date).getTime() / 1000),
      a.utid = this.cna;
      var l = null;
      this.isThirdParty && (l = {
      }, this.config.password && (this.custumPassword = this.config.password, l.password = this.config.password), l.client_id = this.config.client_id, l.video_id = this.config.videoId, l.embsig = this.config.embsig, l.atoken = this.config.atoken, l.refer = encodeURIComponent(window.location.href)),
    ...
    a(t, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          'm3u8' === this.supportType ? this._player = new b.default({
          }) :
      ...
      },
      {
        ...
        value: function (t, e) {
          if (!this.mediaElement) {
            ...
            if (i.id = this.mediaElementId, i.setAttribute('webkit-playsinline', ''), i.setAttribute('playsinline', ''), i.setAttribute('x-webkit-airplay', 'allow'), this.config.isForbidX5 || i.setAttribute('x5-playsinline', ''), this.config.extVideoAttributes) for (var n in this.config.extVideoAttributes) i[n] = this.config.extVideoAttributes[n];
      ...
      },
      {
        ...
        value: function () {
          if (!this.ifEvent && (this.ifEvent = !0, this._player && this._e)) for (var t in S.VIDEO_EVENTS) this._player.on(S.VIDEO_EVENTS[t], this._e[S.VIDEO_EVENTS[t]])
        }
      },
      {
      ...
      },
      {
        key: '_attachAdEvents',
        value: function () {
          this._adplugin && this._adEvent && (this._adplugin.on(T.default.AD_DATA_OK,
          this._adEvent.adDataOk), this._adplugin.on(T.default.AD_DATA_ERROR,
          this._adEvent.adDataError), this._adplugin.on(T.default.AD_PLAY,
          this._adEvent.onAdStartPlay), this._adplugin.on(T.default.AD_PAUSE,
          this._adEvent.onAdPause), this._adplugin.on(T.default.AD_END,
          this._adEvent.onAdEnd), this._adplugin.on(T.default.AD_TIMEUPDATE,
          this._adEvent.onAdTimeUpdate), this._adplugin.on(T.default.AD_ERROR,
          this._adEvent.onAdError), this._adplugin.on(T.default.AD_CANPLAY,
          this._adEvent.onAdCanPlay), this._adplugin.on(T.default.AD_LOADING,
          this._adEvent.onAdLoading), this._adplugin.on(T.default.AD_TIMEOUT,
          this._adEvent.onAdTimeout), this._adplugin.on(T.default.AD_READY,
          this._adEvent.onAdReady))
        }
      }, {
        key: '_dettachAdEvents',
        value: function () {
          this._adplugin && this._adEvent && (this._adplugin.off(T.default.AD_DATA_OK,
          this._adEvent.adDataOk), this._adplugin.off(T.default.AD_DATA_ERROR,
          this._adEvent.adDataError), this._adplugin.off(T.default.AD_PLAY,
          this._adEvent.onAdStartPlay), this._adplugin.off(T.default.AD_PAUSE,
          this._adEvent.onAdPause), this._adplugin.off(T.default.AD_END,
          this._adEvent.onAdEnd), this._adplugin.off(T.default.AD_TIMEUPDATE,
          this._adEvent.onAdTimeUpdate), this._adplugin.off(T.default.AD_ERROR,
          this._adEvent.onAdError), this._adplugin.off(T.default.AD_CANPLAY,
          this._adEvent.onAdCanPlay), this._adplugin.off(T.default.AD_LOADING,
          this._adEvent.onAdLoading), this._adplugin.off(T.default.AD_TIMEOUT,
          this._adEvent.onAdTimeout), this._adplugin.off(T.default.AD_READY,
          this._adEvent.onAdReady))
        }
      }, {
        key: '_isThirdParty',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.isThirdParty && (t.partnerid = this.config.client_id, t.atm = this.thirdData && this.thirdData.atm ? this.thirdData.atm : '');
          var e = {
          };
          e.param = t,
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (this._firstTag) {
            ...
            this.vv59 || (this._reporter.addPlayerDurationReport(59), this.vv59 = !0),
            this._userPause ? u.default.i(this.TAG, 'autoplay and userPause is true; block play') :
            (u.default.i(this.TAG, 'autoplay and userPause is false;'),
            e = this._player.play()), this._headTime > 0 && this.config.isSkip && !this._headSkip && (this._lastSeekTime = this._headTime, this._headSkip = !0, this.seek(this._headTime))
      ...
      },
      {
        ...
        value: function () {
          if (this._videoInfo.langcodes) {
            ...
            s = n.join(',') + ',';
            s.indexOf(this.control.hd + ',') < 0 && (this.control.hd = n[0]),
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this._firstTag && (this._firstTag = !1, this._reporter.addPlayerDurationReport(60), this._reporter.sendTSLog(60), this._reporter.sendUPSLog(3)),
          this.isPause = !1,
          this.onPlay()
        }
      },
      ...
      },
      {
        key: '_onEnded',
        value: function (t) {
          this.isEnd || (this.currentState = L.YKP.PLAYER_STATE.END, this.isEnd = !0, this._reporter.addPlayerDurationReport(61), this._reporter.sendTSLog(61), this.getTrialInfo() || this._replay || this._endAd ? (u.default.d(this.TAG, 'onEnded'),
        ...
        value: function (t) {
          ...
          this.onCanplay(t),
          this._lastSeekTime > 0 && (this.seek(this._lastSeekTime), this._lastSeekTime = 0)
        }
      },
      {
        key: '_onTimeupdate',
        value: function (t, e) {
          e <= this.totalTime && (this.currentTime = e, this.onTimeupdate(t, e), this._adplugin.posiTimeUpdate(e)),
          this._tailTime > 0 && this.config.isSkip && !this._tailSkip && e >= this._tailTime && (this._tailSkip = !0, this.seek(this.totalTime))
        }
      },
      {
        key: '_onError',
        value: function (t) {
          ...
          } else this.sendErrorLog('31', '31602'); this.onError(t)
        }
      },
      {
        key: '_onLoadeddata',
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          this._isAdPlaying || (this._isAdPlaying = !0, this._reporter.sendUPSLog(1)),
          'front' !== e || this.vv59 || (this._reporter.addPlayerDurationReport(59), this.vv59 = !0),
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          'front' === e) {
            ...
            this.playBlock(i)
          } else 'end' === e && (this._endAd = !0, this._isAdPlaying = !1, this.currentState = L.YKP.PLAYER_STATE.END, this.onEnded()); this._player.adStatus = !1
        }
      },
      {
        key: '_onAdPause',
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          'm3u8' !== this.supportType || this._frontAd ? (this._adError = !0, this._onAdEnd(t, e), void this.onAdError(t, e))  : void this._m3u8SwitchToMp4()
        }
      },
      {
        key: '_onAdTimeout',
      ...
      },
      {
        ...
        value: function () {
          ...
          !this.error) {
            if (this._userPause = !1, this.currentState === L.YKP.PLAYER_STATE.END) return this.isEnd = !1,
            void this.replay();
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.error || this.currentState === L.YKP.PLAYER_STATE.INIT || this.currentState === L.YKP.PLAYER_STATE.READY || this.isEnd || (t || (this._userPause = !0), this._isAdPlaying ? (this.currentState = L.YKP.PLAYER_STATE.ADPAUSE, this._adplugin.pause())  : (this.sendEventLog('xPa', 'c'), this._player.pause(), this.currentState = L.YKP.PLAYER_STATE.PAUSE))
        }
      },
      {
        key: 'playBlock',
      ...
      },
      {
        ...
        value: function (t, e, i) {
          ...
          if (n.vid = t, i && i.control && (this.control = i.control), this.control.autoplay = !0, i && i.param) for (var s in i.param) n[s] = i.param[s];
          var a = this.getAdParam();
          if (a) for (var o in a) n[o] = a[o];
          var r = null;
          i && this.isThirdParty ? (r = {
          }, this.custumPassword = i.password, r.password = i.password, r.embsig = i.embsig, r.refer = i.refer)  : this.custumPassword = null,
      ...
      },
      {
        key: 'changeLanguage',
        value: function (t, e) {
          if (t === this.control.lang) return u.default.i(this.TAG, ' this.control.lang:' + this.control.lang + '  langCode:' + t + '  this.currentState:' + this.currentState),
          !1;
          if (this.currentState === L.YKP.PLAYER_STATE.ERROR || this.currentState === L.YKP.PLAYER_STATE.INIT || this.currentState === L.YKP.PLAYER_STATE.ADPLAY || this.currentState === L.YKP.PLAYER_STATE.ADPAUSE) return this.control.lang = t,
          e && e(this.control),
          !0;
          var i = {
          };
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          if (t === this.control.hd) return u.default.i(this.TAG, ' this.control.hd:' + this.control.hd + '  hdCode:' + t + '  this.currentState:' + this.currentState),
          !1;
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          n.indexOf('m3u8') > - 1 ? (i.m3u8Url = n, i.cdnUrl = '')  : (i.cdnUrl = n, i.m3u8Url = ''),
    ...
    o = (i(a), function () {
      ...
      return s(t, null, [
        ...
        },
        {
          ...
          value: function (e) {
            e = '***' + e,
            t.dom ? t.dom.innerHTML = t.dom.innerHTML + '<br>' + e : document.getElementById(t.DOMID) ? t.dom = document.getElementById(t.DOMID)  : (t.dom = document.createElement('div'), document.getElementsByTagName('body') [0].appendChild(t.dom))
          }
        }
      ]),
      t
  ...
  function (t, exports) {
    ...
    var e = {
      ...
      core_hmac_md5: function (t, e) {
        ...
        for (var n = Array(16), s = Array(16), a = 0; a < 16; a++) n[a] = 909522486 ^ i[a],
        s[a] = 1549556828 ^ i[a];
      ...
      binl2b64: function (t) {
        for (var e = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', i = '', n = 0; n < 4 * t.length; n += 3) for (var s = (t[n >> 2] >> 8 * (n % 4) & 255) << 16 | (t[n + 1 >> 2] >> 8 * ((n + 1) % 4) & 255) << 8 | t[n + 2 >> 2] >> 8 * ((n + 2) % 4) & 255, a = 0; a < 4; a++) i += 8 * n + 6 * a > 32 * t.length ? this.b64pad : e.charAt(s >> 6 * (3 - a) & 63);
        return i
      }
    };
    exports.default = e
  ...
  function (t, exports) {
    t.exports = function (t) {
      ...
      t.env._versionReady || (t.env._versionReady = !0, e.prototype.toString = function () {
        return this.val
      }, e.prototype.valueOf = function () {
        for (var t = this.val.split('.'), e = [
        ], i = 0; i < t.length; i++) {
          var n = parseInt(t[i], 10);
          isNaN(n) && (n = 0);
          var s = n.toString();
  ...
  function (t, exports, e) {
    ...
    u = {
      ...
      getVersions: function () {
        ...
        e = parseInt(10000 * t[0]) + parseInt(100 * t[1]) + parseInt(10 * t[2]);
        return e
      },
      assign: function (t) {
    ...
    o = function () {
      ...
      return s(t, [
        ...
        },
        {
          ...
          value: function () {
            var t = this.protocol + '//';
            return this.username && (t += this.username, this.password && (t += ':' + this.password), t += '@'),
            t += this.hostname,
        ...
        },
        {
          ...
          get: function () {
            ...
            for (var e in this._params) if (void 0 !== this._params[e]) if ('' !== this._params[e]) try {
  ...
  function (t, exports, e) {
    ...
    function n(t, e) {
      ...
      if (!L) for (var n in i.params) t.params.hasOwnProperty(n) || (t.params[n] = i.params[n]);
      if ('object' === ('undefined' == typeof e ? 'undefined' : f(e))) for (var s in e) 'number' == typeof e[s] ? t.params[s] = '' + e[s] : 'function' == typeof e[s] ? t.params[s] = '' : t.params[s] = e[s];
      return t
    }
    function s(t, e) {
    ...
    function r(t) {
      if (t instanceof d) for (var e in t._params) null !== t.params[e] && 'undefined' !== t.params[e] && '' !== t.params[e] || delete t.params[e]
    }
    function l(t) {
    ...
    O = {
      gotoApp: function () {
        ...
        return C.track(t.params),
        u ? s(O.dealUrl(i), p)  : h && v.isIOS ? a('https://itunes.apple.com/app/id336141475')  : w ? v.isIPhone ? p && t.guide ? o(t)  : a('https://itunes.apple.com/app/id336141475')  : a(I + '&android_schema=' + encodeURIComponent(i.toString()))  : !p || t.universalLinkState === !1 || T || A ? 'intent:' === i.protocol ? setTimeout(function () {
          a(O.dealUrl(i))
        }, 100)  : s(O.dealUrl(i), p)  : o(t),
        O.dealUrl(i)
      },
      download: function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
    ...
    d = function () {
      ...
      return s(t, [
              ...
              if (!e.isSendSus) {
                ...
                if ('undefined' != typeof i) {
                  for (var n = 0; n < i.length; n++) {
                    var s = i[n].U;
                    o.default.sendlog(s),
                    'https:' === o.default.protocol && (/^https/.test(s) || (this.sendAdLog(3, 309), this.sendAdGold({
                      p: 1,
                      code: 309
                    }, {
                      index: t
        ...
        },
        {
          ...
          value: function (t) {
            if (this.addata) {
              ...
              for (var n = null, s = 1000000, a = 100000, r = 0; r < i.length; r++) {
                var l = i[r].U,
                u = parseInt(i[r].T, 10),
                d = t - u;
                d >= 0 && d < a && (a = d, n = l, s = u)
          ...
          value: function (t) {
            if (this.addata) {
              ...
              if ('undefined' != typeof i) {
                ...
                for (var n = 10000, s = 1000000, a = 0; a < i.length; a++) {
                  var r = (i[a].U, parseInt(i[a].T, 10)),
                  l = t - r;
                  l >= 0 && l < n && (n = l, s = r)
                }
                if (1000000 != s && this._sucache.indexOf(s) == - 1) {
        ...
        },
        {
          ...
          value: function (t) {
            if (this.addata) {
              var e = this.addata.VAL[0],
              i = e.CUM;
              if ('undefined' != typeof i && 0 !== i.length) for (var n = 0; n < i.length; n++) if (t < parseInt(i[n].T, 10)) {
                for (var s = 0; s < (i[n].CUM || [
                ]).length; s++) o.default.sendlog(i[n].CUM[s].U);
                break
              }
            }
          }
        ...
        },
        {
          key: 'sendDotSUS',
          value: function (t) {
            if (t && t.SUS) for (var e = 0; e < t.SUS.length; e++) {
              var i = t.SUS[e].U;
              o.default.sendlog(i)
            }
          }
        },
        {
          key: 'sendDotSUE',
          value: function (t) {
            if (t && t.SUE) for (var e = 0; e < t.SUE.length; e++) {
              var i = t.SUE[e].U;
              o.default.sendlog(i)
            }
          }
        },
        {
          ...
          value: function (t, e, i) {
            ...
            if (s.p = i && i.p ? i.p : 7, s.ccode = this.ccode, '0505' === this.ccode ? s.st = 2 : s.st = 1, u.browser.isIPad ? s.bt = 0 : u.browser.isAndroid || u.browser.isIPhone || u.browser.isIPod ? s.bt = 1 : s.bt = 4, u.browser.isIOS ? s.os = 0 : u.browser.isAndroid ? s.os = 1 : u.browser.isWindows ? s.os = 2 : s.os = 5, s.avs = l.default.version,
            i && i.addata && i.addata.REQID && (s.reqid = i.addata.REQID),
            s.sid = this.videoInfo && this.videoInfo.ups ? this.videoInfo.ups.psid : '',
            i && i.addata && i.addata.VAL && i.addata.VAL.length > 0) {
              for (var a = [
              ], r = 0, d = i.addata.VAL.length; r < d; r++) a.push(i.addata.VAL[r].IE);
              s.ie = a.join(',')
            } else s.ie = ''; s.appid = 'mw'; var h = {
              protocol: o.default.protocol
            };
            if (h.ie = s.ie, this.videoInfo && this.videoInfo.user && (h.vip = this.videoInfo.user.vip), i && i.ext) for (var c in i.ext) h[c] = i.ext[c];
            i && i.IE ? s.ie = i.IE : s.ie = '';
            var f = '';
            for (var p in h) f += p + ':' + h[p] + ';';
            s.ext = encodeURIComponent(f),
            o.default.sendlog(n + '?' + o.default.urlParameter(s))
          }
        },
        {
          key: 'sendAdGold',
          value: function (t, e) {
            ...
            this.addata && (t.count = this.addata.VAL ? this.addata.VAL.length : 0, t.reqid = this.addata.REQID),
            e && (t.count = e.VAL ? e.VAL.length : t.count, t.index = e.index);
            var i = [
            ];
        ...
        [
          {
            ...
            value: function (t) {
              var e = t.VAL[0].CUM;
              if (e) for (var i = 0; i < e.length; i++) o.default.sendlog(e[i].U)
            }
          },
          {
            key: 'sendPauseAdSUS',
      ...
      function (t, exports) {
        ...
        function e() {
          ...
          /youku|youku_hd/i.test(navigator.userAgent) && 'object' === i(window.WindVane) ? /iphone|ipod|ipad/i.test(navigator.userAgent) ? (t.url = 'youku://openWVH5?url=' + t.url, window.WindVane.call('DYKBaseJSBridge', 'nativeOpen', t, function (t) {
          }, function () {
            location.href = t.url
          }))  : window.WindVane.call('WVPopLayer', 'navToUrl', t, function (t) {
          }, function () {
            window.WindVane.call('WVLoadBridge', 'loadUrl', t, function () {
            }, function () {
              location.href = t.url
            })
          })  : location.href = t.url
      ...
      function (t, exports, e) {
          ...
          return s(t, [
            {
              ...
              value: function () {
                ...
                this.adBtns.skipBtn = a.util.get('.x-advert-txt', t) [0],
                this.adBtns.timeNum = a.util.get('.x-advert-sec', t) [0],
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (e) {
                  ...
                  o = 0.7 * n,
                  r = 0.7 * n * (430 / 600);
                  n / s > 600 / 430 && (o = 0.7 * s * (600 / 430), r = 0.7 * s),
                  i.style.width = o + 'px',
                  i.style.height = r + 'px',
            ...
            },
            {
              ...
              value: function (t, e) {
                return this.num = e,
                t >= this.totalTime ? void this.hide()  : void (this.lastTime > 0 && t - this.lastTime < 0.5 || (this.lastTime = t, this.adBtns.timeNum.innerHTML = parseInt(this.totalTime - t)))
              }
            }
            ]),
            t
        ...
        function (t, exports, e) {
          ...
          function s(t, e) {
            ...
            if (!U) for (var n in i.params) t.params.hasOwnProperty(n) || (t.params[n] = i.params[n]);
            if ('object' === ('undefined' == typeof e ? 'undefined' : h(e))) for (var s in e) 'number' == typeof e[s] ? t.params[s] = '' + e[s] : 'function' == typeof e[s] ? t.params[s] = '' : t.params[s] = e[s];
            return t
          }
          function a(t, e) {
          ...
          function r() {
            ...
            n && (n = new f.default(n)), t.exdParams && n && s(n, t.exdParams), l(n), n = n.toString(), e.fallback_url = n, e.fua = /Safari\/\d+(\.\d+)*$/.test(navigator.userAgent) ? 'safari' : 'other', e.special = 1, e.ts = (new Date).getTime(), e.action = e.action ? e.action : 'play'; var a = new f.default(t.universalLink || O);
            s(a, e),
          ...
          function l(t) {
            if (t instanceof f.default) for (var e in t._params) null !== t.params[e] && 'undefined' !== t.params[e] && '' !== t.params[e] || delete t.params[e]
          }
          function u(t) {
            var e = document.cookie.match(RegExp('(^| )' + t + '=([^;]*)(;|$)'));
            return null !== e ? unescape(e[2])  : null
          ...
          N = {
            gotoApp: function () {
              ...
              n ? a(N.dealUrl(i), p)  : d && b.isIOS ? o('https://itunes.apple.com/app/id336141475')  : k ? b.isIPhone ? p && t.guide ? r(t)  : o('https://itunes.apple.com/app/id336141475')  : o(C + '&android_schema=' + encodeURIComponent(i.toString()))  : !p || t.universalLinkState === !1 || S || I ? 'intent:' === i.protocol ? setTimeout(function () {
                o(N.dealUrl(i))
            ...
            gotoPage: function () {
              ...
              if (t = (0, _.default) ({
                timeout: T
              }, t), t.targetUrl = N.gotoApp(t), x) return t.targetUrl; if (t.isNeedDownload) var e = window.setTimeout(function () {
                clearTimeout(e),
                N.download(t)
              }, t.timeout);  else if (t.uri) var i = window.setTimeout(function () {
                clearTimeout(i),
                o(t.uri, t.replace)
              }, t.timeout); return t.targetUrl
            },
            dealUrl: function (t) {
              if (t._params.openHalfUrl && t._params.openHalfUrl.length) {
                var e = t._params.openHalfUrl;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e = this.hdList.filter(function (e, i, n) {
                    var s = !0;
                    return '标清' === e.hdname && (s = !1, t ? '3gphd' === e.hdcode && (t = e)  : t = e),
                    s
                  });
                  t && e.unshift(t),
                  this.hdList = e,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.hdList.forEach(function (e) {
                    ...
                    e.hdcode === t.hd && (t.hdCh = e.hdname, i.setAttribute('class', 'current')),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.langList.forEach(function (e) {
                    ...
                    e.langcode === t.lang && (t.langCh = e.lang, i.setAttribute('class', 'current')),
        ...
        function (t, exports, e) {
          ...
          m = function () {
            function t(e, i, s) {
              ...
              this.downloadUrl = c.browser.isAndroid ? 'https://down2.youku.com/youku/down.php?pub=6d43cbf537192324' : 'https://itunes.apple.com/cn/app/id336141475?mt=8',
              this.btns = {
              },
              this.e = {
              },
            ...
            return s(t, [
              {
                ...
                value: function () {
                  ...
                  this.btns.limitNote = a.util.createElement('', '', '本页面仅支持试看50分钟，更多内容尽在优酷App', 'span'),
                  ...
                  this.btns.hintOpen = a.util.createElement('x-hint-openapp', '', '打开优酷APP观看完整版', 'button'),
              ...
              },
              {
                key: 'showDrmLimit',
                value: function (t) {
                  t && (this.btns.limitOpen.innerHTML = t, this.btns.limitNote.innerHTML = '抱歉，因版权原因无法观看此视频'),
              ...
              },
              {
                ...
                value: function (t, e, i) {
                  ...
                  i ? (this.timeCount = 1000 * parseInt(i, 10), a.util.show(this.timerNoteDom), a.util.hide(this.btns.retryBtn), void this.createTimer())  : (a.util.hide(this.timerNoteDom), void (e ? a.util.hide(this.btns.retryBtn)  : a.util.show(this.btns.retryBtn)))
                }
              },
              {
                key: 'createTimer',
                value: function () {
                  if (this.timerDom.innerHTML = parseInt(this.timeCount / 1000, 10), this.timeCount > 0) {
                    this.timeCount -= 300;
                    var t = this;
                    setTimeout(function () {
                      t.createTimer()
                    }, 300)
                  } else a.util.hide(this.timerNoteDom),
              ...
              },
              {
                ...
                value: function (t, e) {
                  if (this.callAppOpts) {
                    if (c.browser.isYouku) return this._player.pause(),
                    void h.default.play({
                      vid: this.encodeid
                    });
                    this.callAppOpts.params.source = t,
                    this.vid && (this.callAppOpts.universalLinkState = !0, this.callAppOpts.exdParams.position = t, this.callAppOpts.params.vid = this.vid, this.callAppOpts.params.action = 'play', this.callAppOpts.pathname = 'play', this.callAppOpts.refer = location.href),
                    e && (this.callAppOpts.downloadUrl = e),
                    window.vid && (this.callAppOpts.params.source = 'a2h0j.10182321.' + this.callAppOpts.params.source),
                    window.vData && (this.callAppOpts.params.data_vdotype = window.toFind ? 'short' : 'long', this.callAppOpts.params.data_logver = 'v2'),
                    this.exdUrl ? (this.callAppOpts.downloadUrl = this.exdUrl, u.default.download(this.callAppOpts)) : u.default.gotoPage(this.callAppOpts)
                  }
                }
              },
              {
          ...
          function (t, exports, e) {
            ...
            _ = function () {
              ...
              return s(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.payInfo.vipPayInfo && this.payInfo.vipPayInfo.result && this.payInfo.vipPayInfo.result.pay_scenes) {
                      ...
                      if (s && s.length > 0) {
                        ...
                        o.components && o.components.forEach(function (n) {
                          'title' === n.code && (e = n.text),
                          'subtitle' === n.code && (i = n.text),
                          'button' === n.type && t.payButtonList.push({
                            text: n.text,
                    ...
                    i && (this.subInfoDom = a.util.createElement('x-tips-subTitle', '', i, 'div'), this.showTipDom.appendChild(this.subInfoDom)),
                    ...
                    this.payButtonList.length > 0 && this.payButtonList.forEach(function (e, i) {
                      if (0 === i) {
                        ...
                        e.cornerText && (t.tryBtnCorner = a.util.createElement('x-btn-corner', '', e.cornerText, 'i'), t.tryBtn.appendChild(t.tryBtnCorner))
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.buy_link = 'https://h5.vip.youku.com/cashdesk?type=vip&tags=h5playbox_001&refer=' + v + '&en_vid=' + (this.videoInfo && this.videoInfo.encodeid),
                  ...
                  value: function (t) {
                    if (this.payButtonList && this.payButtonList.length > 0) {
                      ...
                      if ('vod' !== n) {
                        ...
                        o = 'h5player_yongquan';
                        a.params.source = o,
                        this.videoInfo && (a.universalLinkState = !0, a.exdParams.position = o, a.params.vid = this.videoInfo.encodeid, a.params.action = 'play', a.pathname = 'play', a.refer = location.href),
                        a.downloadUrl = f.browser.isAndroid ? 'https://down2.youku.com/youku/down.php?pub=6d43cbf537192324' : 'https://itunes.apple.com/cn/app/id336141475?mt=8',
                        c.default.gotoPage(a)
                      }
                      try {
              ...
              function s(t, e) {
                ...
                s = void 0,
                a = e.refCoord;
                if (e.rsUrl) if (i.background = 'url("' + e.rsUrl + '") 0 0 no-repeat', e.width && e.height) i.backgroundSize = e.width + 'px ' + e.height + 'px';
                 else {
                  var o = window.getComputedStyle(t, null);
                  i.backgroundSize = o.width + ' ' + o.height
                }
                0 === a ? (n = 'left', s = 'top')  : 1 === a ? (n = 'right', s = 'top')  : 2 === a ? (n = 'right', s = 'bottom')  : 3 === a && (n = 'left', s = 'bottom'),
                i[n] = e.posX + 'px',
                i[s] = e.posY + 'px';
              ...
              I = function () {
                function t(e, i, s) {
                  ...
                  this._adPannel = new m.default(this.btn.adBtn, this.btn.pauseAdBtn),
                  ...
                  this._uiInit(),
                  this.config.poster && (this.initPoster(), r.util.show(this.btn.poster), i.config.purePlay || this.showMidPlayBtn(), this.hideLoading()),
                ...
                return a(t, [
                  {
                    ...
                    value: function () {
                      ...
                      0 !== r.util.getScreenState() && (r.util.hide(this.btn.nextVid), r.util.hide(this.btn.changeBtn)),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var t = this;
                      this.config.dash ? (this.config.dash.play && r.util.hide(this.btn.playBtn), this.config.dash.next && r.util.hide(this.btn.nextVid), this.config.dash.full && (r.util.hide(this.btn.fullScreenBtn), this._progress.changeProcessStyle('right')), this.config.dash.change && r.util.hide(this.btn.changeBtn), this.config.dash.play && !this.config.dash.full ? this._progress.changeProcessStyle('left')  : !this.config.dash.play && this.config.dash.full ? this._progress.changeProcessStyle('right')  : this.config.dash.play && this.config.dash.full && this._progress.changeProcessStyle('mid'), this.config.showMutedIcon && this.showMutedBtn())  : this.config.dash = {
                      },
                      this.config.isFeed && (r.util.hide(this.btn.playBtn), this.config.dash.full ? this._progress.changeProcessStyle('mid')  : this._progress.changeProcessStyle('left')),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (t.posterUrl) if (this.btn.poster.children.length > 0) this.btn.poster.children[0].src = t.posterUrl;
                       else {
                        var i = document.createElement('img');
                        i.src = t.posterUrl,
                    ...
                    value: function (t) {
                      if (this._noticePannel.hideError(), this._video = this._player.getVideoInfo(), this._video) {
                        ...
                        if (this.btn.title.innerHTML = r.util.htmlEncodeAll(e), this._noticePannel.initData(this._video.id, this._video.encodeid), !this._player.getError()) {
                          this._hdInfoPannel || (this._hdInfoPannel = new w.default(this.btn.changeBtn, this.btn.hdshowDom)), this._hdInfoPannel.init(this._player.control.lang, this._player.control.hd, this._player.getLanguageList(), this._player.getHdList(), this._player), this.hideChangeBtn(), this.showTitle(); var i = this._player.getVideoInfo(), n = i ? i.seconds : 0, s = parseInt(n / 60); n = parseInt(n % 60), n = n > 9 ? n : '0' + n, s = s > 9 ? s : '0' + s, this.btn.timeBar.innerHTML = s + ':' + n, this._player.config.purePlay ? (this.hideLoading(), this.hideMidPlayBtn())  : this._player.control.autoplay ? r.util.hide(this.btn.poster)  : (this.hideLoading(), this.showMidPlayBtn(), r.util.show(this.btn.poster)); var a = null; this._player.getTrialInfo() && (a = parseInt(this._player.getTrialInfo().time)), this._progress.init(this._video.seconds, 0, 0), this._prompt.init(this._video.seconds, 0, a), this.showRegisterNum(), this.showLogo(), this._bindEvent(); var o = (this._player.getVideoInfo().type.join(','), this._player.getPayInfo()); if (o && o.can_play === !1) this._payInfoPannel || (this._payInfoPannel = new g.default(this.btn.payDom),
                          this._payInfoPannel._emitter.on('tryPlay', this.e.play)), this._payInfoPannel.init(this._video, this._player.getTrialInfo(), this._player.getPayInfo(), null, this.config), r.util.show(this.btn.poster);  else {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      e && (this.btn.license.innerHTML = e.text, s(this.btn.license, e), r.util.show(this.btn.license)),
                      i && (this.btn.register.innerHTML = i.text, r.util.show(this.btn.register), s(this.btn.register, i));
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      this._player.isPause || this._player.mediaElement.paused ? (this._player.sendGoldLog('/yt/youkuphoneplaypage.myoukuinteraction.click_to_player', 'CLK', 'click_type=play_button', 'H1568306482'), this._player.play())  : (this._player.sendGoldLog('/yt/youkuphoneplaypage.myoukuinteraction.click_to_player', 'CLK', 'click_type=stop', 'H1568306482'), this._player.pause()),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      e ? (this.btn.mutedBtn.setAttribute('data-muted', 1), r.util.addClass(this.btn.mutedBtn, 'x-close-muted'))  : (r.util.removeClass(this.btn.mutedBtn, 'x-close-muted'), this.btn.mutedBtn.setAttribute('data-muted', 0))
                    }
                  },
                  {
                    key: 'onPlay',
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this.config.isFeed ? (this.switchTriggerMidBtnStatus(this.class .pause), void this.showTriggerMidPlayBtn())  : this.config.dash && this.config.dash.pauseState ? (this.hideDash(null, !0), void this.showMidPlayBtn())  : void (this.isIOS10 || !this.isIOS ? this.showDash(null, !0)  : this.showMidPlayBtn())
                    }
                  },
                  {
                    key: 'onTimeUpdate',
                    value: function (t) {
                      ...
                      (0 === t || 1000 * Math.abs(t - this.lastTime) >= 500) && (this.lastTime = t, this._progress.update(t))
                    }
                  },
                  {
                    key: 'onEnded',
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      n = i ? i.seconds : 0,
                      s = parseInt(n / 60);
                      if (n = parseInt(n % 60), n = n > 9 ? n : '0' + n, s = s > 9 ? s : '0' + s, this.btn.timeBar.innerHTML = s + ':' + n, r.util.show(this.btn.poster), this.hideLoading(), this.hideMidPlayBtn(), this.hideDash(!0), !t || !t.code) return this.showError('播放错误，请重试'),
                      ...
                      if (l && this._noticePannel.initData(l.id, l.encodeid), '-2002' === a || '-2003' === a) {
                        ...
                        this.showLimitDrm(d)
                      } else if ('-3007' === a || '-3008' === a || '-3001' === a || '-3002' === a || '-3003' === a) this.initPoster(),
                      r.util.show(this.btn.poster),
                      this._video || (this._video = this._player.getVideoInfo()),
                      this._payInfoPannel || (this._payInfoPannel = new g.default(this.btn.payDom)), this._payInfoPannel.init(this._video, '', this._player.getPayInfo(), a, this.config), this._payInfoPannel.show(), this.showTitle();  else if ('-3006' === a) {
                        var h = t.note;
                        this.showError(h, !0)
                      } else {
                        var c = t && t.note ? t.note : '播放错误';
                        '-1002' === a && (c = '该视频已被屏蔽，您可以尝试<font color="#22B8FE"><u>搜索</u></font>操作'),
                        this.showError(c, !0)
                      }
                    }
                  },
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      if (!this.isFocusHideDash && (t && this._player.sendEventLog('xCd', 'c'), !this._player.config.purePlay)) {
                        ...
                        var e = this;
                        this.dashtimer && (clearTimeout(this.dashtimer), this.dashtimer = null),
                  ...
                  },
                  {
                    key: 'hideLoading',
                    value: function () {
                      this.loadingTimer && (window.clearTimeout(this.loadingTimer), this.loadingTimer = null),
                  ...
                  },
                  {
                    key: 'onAdPlay',
                    value: function () {
                      this.adplay || (this.hideDash(!0), this.hideLogo(), r.util.hide(this.btn.title), r.util.hide(this.btn.poster), r.util.hide(this.btn.timeBar), this.hideRegisterNum(), r.util.hide(this.btn.minProgress)),
                      this.adplay = !0,
                      this.hideMidPlayBtn(),
                      this.showLoading()
                    }
                  ...
                  return s(t, [
                    {
                      ...
                      value: function () {
                        ...
                        this.btn.played.style.width = '8px',
                        ...
                        this.minDom && (this.btn.minLoaded = a.util.createElement('x-progress-load-mini', '', '', 'span'), this.btn.minPlayed = a.util.createElement('x-progress-play-mini', '', '', 'span'), this.minDom.appendChild(this.btn.minLoaded), this.minDom.appendChild(this.btn.minPlayed), a.util.hide(this.minDom))
                      }
                    },
                    {
                    ...
                    },
                    {
                      ...
                      value: function (t, e, i) {
                        ...
                        this.btn.minLoaded && (this.btn.minPlayed.style.width = n + '%', this.btn.minLoaded.style.width = s + '%'),
                    ...
                    },
                    {
                      ...
                      value: function (t, e) {
                        if (t || 0 === t) {
                          ...
                          i * this._trackWidth < 10 && (i = 10 / this.btn.track.offsetWidth),
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        if (!this.hide) {
                          ...
                          this._config.disablePlayerSlide || (a.util.addEventListenerHander(this.btn.trigger, 'touchmove', this.e.touchmove), a.util.addEventListenerHander(this.btn.trigger, 'touchend', this.e.touchend))
                        }
                      }
                    },
                    {
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        this._config.disablePlayerSlide || (a.util.removeEventListenerHander(this.btn.trigger, 'touchmove', this.e.touchmove), a.util.removeEventListenerHander(this.btn.trigger, 'touchend', this.e.touchend)),
                        this.isTouching = !1
                      }
                    }
                  ]),
                  ...
                  return s(t, [
                    ...
                    },
                    {
                      ...
                      value: function (t, e) {
                        ...
                        e <= 0 ? (this.stateDom.className = this.class .back, a.util.show(this.parentDom))  : (this.stateDom.className = this.class .forward, a.util.show(this.parentDom)),
                        this.autoHide();
                        var i = this;
              ...
              function (t, exports, e) {
                ...
                s = {
                  ...
                  check: function () {
                    for (var t = this.uaConfig && this.uaConfig.uaList ? this.uaConfig.uaList : [
                    ], e = navigator.userAgent.toLowerCase(), i = 0, n = t.length; i < n; i++) if (e.indexOf(t[i].uaKey.toLowerCase()) > - 1) return !0
                  },
                  callBack: function () {
                    if (this.check() && this.callBackList.length > 0) for (var t = 0, e = this.callBackList.length; t < e; t++) this.callBackList[t](!0)
                  }
                };
              ...
              function (t, exports) {
                ...
                function e(t, e) {
                  function i() {
                    ...
                    p.transitions && e.continuous && m.length < 3 && (g.appendChild(m[0].cloneNode(!0)), g.appendChild(g.children[1].cloneNode(!0)), m = g.children),
                    ...
                    for (var i = m.length; i--; ) {
                      ...
                      p.transitions && (n.style.left = i * - _ + 'px', r(i, b > i ? - _ : b < i ? _ : 0, 0))
                    }
                    e.continuous && p.transitions && (r(a(b - 1), - _, 0), r(a(b + 1), _, 0)),
                    ...
                    S = {
                      ...
                      move: function (t) {
                        if (!(t.touches.length > 1 || t.scale && 1 !== t.scale)) {
                          ...
                          T || (t.preventDefault(), h(), e.continuous ? (l(a(b - 1), P.x + v[a(b - 1)], 0), l(b, P.x + v[b], 0), l(a(b + 1), P.x + v[a(b + 1)], 0))  : (P.x = P.x / (!b && P.x > 0 || b == m.length - 1 && P.x < 0 ? Math.abs(P.x) / _ + 1 : 1), l(b - 1, P.x + v[b - 1], 0), l(b, P.x + v[b], 0), l(b + 1, P.x + v[b + 1], 0)))
                        }
                      },
                      end: function (t) {
                        ...
                        e.continuous && (s = !1);
                        var o = P.x < 0;
                        T || (n && !s ? (o ? (e.continuous ? (r(a(b - 1), - _, 0), r(a(b + 2), _, 0))  : r(b - 1, - _, 0), r(b, v[b] - _, w), r(a(b + 1), v[a(b + 1)] - _, w), b = a(b + 1))  : (e.continuous ? (r(a(b + 1), _, 0), r(a(b - 2), - _, 0))  : r(b + 1, _, 0), r(b, v[b] + _, w), r(a(b - 1), v[a(b - 1)] + _, w), b = a(b - 1)), e.callback && e.callback(b, m[b]))  : e.continuous ? (r(a(b - 1), - _, w), r(b, 0, w), r(a(b + 1), _, w))  : (r(b - 1, - _, w), r(b, 0, w), r(b + 1, _, w))),
              ...
              function (t, exports, e) {
                    ...
                    },
                    {
                      ...
                      value: function () {
                        this.promise.then(function (t) {
                          ...
                          ], n = 0, s = t.length; n < s; n += 2) e.push(t.slice(n, n + 2));
                          e = e.splice(0, 4);
                          for (var a = 0, r = e.length; a < r; a++) {
                            for (var l = o.util.createElement('swiper-item'), u = 0, d = e[a].length; u < d; u++) {
                              ...
                              f.setAttribute('vid', e[a][u].id),
                              f.setAttribute('codeId', e[a][u].codeId),
                              p.setAttribute('vid', e[a][u].id),
                              m.setAttribute('vid', e[a][u].id),
                              v.setAttribute('vid', e[a][u].id),
                              _.setAttribute('vid', e[a][u].id),
                              p.appendChild(m),
                              p.appendChild(v),
                              f.appendChild(p),
                              f.appendChild(_),
                              l.appendChild(f),
                              o.util.addEventListenerHander(f, 'click', this.e.openApp)
                            }
                            i.push('<i></i>'),
                            this.sliderDotsDom.innerHTML = i.join(''),
                            this.sliderDotsDom.querySelectorAll('i') [0].setAttribute('class', 'on'),
                            this.sliderItemsDom.appendChild(l)
                          }
                        }.bind(this))
                      }
                    },
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        (0, g.default) ({
                          ...
                          videoId: window.vid || ''
                        }, 'CLK'); var e = t.target.getAttribute('vid'), i = t.target.getAttribute('codeId'); if (this._player.sendGoldLog('/yt/youkuphoneplaypage.myoukuinteraction.click_to_player', 'CLK', 'click_type=player-recommend', 'H1568306482'), this.callAppOpts) {
                          if (this.callAppOpts.params.source = 'playerrecommend', e && (this.callAppOpts.exdParams.position = 'playerrecommend', this.callAppOpts.params.vid = e, this.callAppOpts.params.action = 'play', this.callAppOpts.pathname = 'play'), _.browser.isYouku) return this._player.pause(),
                          void v.default.play({
                            vid: i
                          });
                          this.callAppOpts.downloadUrl = 'https://down2.youku.com/youku/down.php?pub=e0f2e926bf37b273',
                          window.vid && (this.callAppOpts.params.source = 'a2h0j.10182321.' + this.callAppOpts.params.source),
                          window.vData && (this.callAppOpts.params.data_vdotype = window.toFind ? 'short' : 'long', this.callAppOpts.params.data_logver = 'v2'),
                          this.exdUrl ? (this.callAppOpts.downloadUrl = this.exdUrl, p.default.download(this.callAppOpts)) : p.default.gotoPage(this.callAppOpts)
                        }
                      }
                    },
                    {
                ...
                function (t, exports, e) {
                  ...
                  c = (l.YoukuH5PlayerCore.STATE, function (t) {
                    function e(t, i, a, o) {
                      ...
                      return i.width && i.height && (l.width = i.width, l.height = i.height),
                      r.h5_firstFlag = !0,
                      r.ad_firstFlag = !0,
                    ...
                    o(e, [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          this.h5_firstFlag && (this.h5_firstFlag = !1, this.config.events && this.config.events.onPlayStart && this.config.events.onPlayStart({
                      ...
                      },
                      {
                        key: 'onAdStartPlay',
                        value: function (t, e) {
                          this.ad_firstFlag && 'front' === e && (this.ad_firstFlag = !1, this.config.events && this.config.events.onAdPlayStart && this.config.events.onAdPlayStart()),
                    ...
                    e
                  }(l.YoukuH5PlayerCore)); exports.default = c
                }, function (t, exports, e) {
                  (function (t) {
                    function i(t, e) {
                      this._id = t,
                  ...
                  t.exports = function (t, e) {
                    if (t.env = t.env || {
                      ...
                      e.match(/Mobile\s+Safari/) ? (t.env.os.name = 'Android', t.env.os.isAndroid = !0)  : (t.env.os.name = 'AndroidPad', t.env.os.isAndroidPad = !0),
                  ...
                  t.exports = function (t, e) {
                    if (t.env = t.env || {
                      ...
                      var u = !1,
                      d = '';
                      (n = e.match(/AliApp\(([A-Z\-]+)\/([\d\.]+)\)/i)) && (s = !0, a = n[1], r = n[2], o = a.indexOf('-PD') > 0 ? t.env.os.isIOS ? 'iPad' : t.env.os.isAndroid ? 'AndroidPad' : t.env.os.name : t.env.os.name),
                      !a && e.indexOf('TBIOS') > 0 && (a = 'TB'),
                      l && (n = l.match(/PopLayer\/([\d\.]+)/i)) && (u = !0, d = n[1]),
                      s ? t.env.aliapp = {
                  ...
                  t.exports = function (t, e) {
                    if (t.env = t.env || {
                    }, !t.env._paramsReady && (t.env._paramsReady = !0, e && (e = e.replace(/^\?/, ''), t.env.params = {
                    }, e))) for (var i = e.split('&'), n = 0; n < i.length; n++) {
                      var s = i[n].split('=') [0],
                      a = s + '=',
                      o = i[n].split(a) [1];
                      i[n] = i[n].split('=');
                  ...
                  function s(t) {
                    if (n(t)) for (var e = 1, i = arguments.length; e < i; ++e) {
                      var s = arguments[e];
                      if (n(s)) for (var a in s) s.hasOwnProperty(a) && (t[a] = s[a])
                    }
                    return t
                  }
                  function a(t, n, s) {
                      ...
                      4: [
                        function (e, i) {
                          (function (e) {
                            ...
                            l = void 0,
                            u = !1;
                            if ('undefined' != typeof e && e.nextTick) u = !0,
                            l = function () {
                              e.nextTick(n)
                            };
                  ...
                  !function (t, e) {
                    ...
                    var T = {
                      ...
                      call: function (e, i, s, a, o, r) {
                        ...
                        if ('number' == typeof arguments[arguments.length - 1] && (r = arguments[arguments.length - 1]), 'function' != typeof a && (a = null), 'function' != typeof o && (o = null), !n || a || o || (d = new n(function (t, e) {
                          a = t,
                          o = e
                        })), !u && T.isNewBridgeAvailable && t.__windvane__ && t.__windvane__.call) return t.__windvane__.call(e + '.' + i, s, a, o, r),
                        d;
                        l = A.getSid();
                        var h = {
                          success: a,
                        ...
                        A.registerCall(l, h),
                        A.registerGC(l, r),
                        T.isAvailable ? A.callMethod(e, i, s, l)  : T.onFailure(l, {
                    ...
                    var A = {
                      ...
                      useIframe: function (t, e) {
                        var i = g + t,
                        n = m.pop();
                        n || (n = s.createElement('iframe'), n.setAttribute('frameborder', '0'), n.style.cssText = 'width:0;height:0;border:0;display:none;'),
                        n.setAttribute('id', i),
                      ...
                      retrieveIframe: function (t) {
                        var e = g + t,
                        i = s.querySelector('#' + e);
                        if (i) if (m.length >= v) try {
                          s.body.removeChild(i)
                        } catch (t) {
                        } else m.indexOf(i) < 0 && m.push(i)
                      },
                      ...
                      onComplete: function (t, e, i, n) {
                        ...
                        e = this.parseData(e);
                        var r = e.ret;
                        'string' == typeof r && (e = e.value || e, e.ret || (e.ret = [
                          r
                        ])),
                        'success' === i ? a && a(e)  : 'failure' === i && o && o(e),
                        l && (this.retrieveIframe(t), this.params[b + t] && delete this.params[b + t])
                      }
                    };
                  ...
                  function s(t) {
                    ...
                    t.target = a.getStringOrEmptyValue([t.target,
                    t.url]),
                    t.fallback = a.getStringOrEmptyValue([t.fallback]),
                    t.vi = a.getStringOrEmptyValue([t.vi,
                    t.v]),
                    t.va = a.getStringOrEmptyValue([t.va,
                    t.v]),
                    t
                  }
                  e(38),
                  ...
                  t.exports = {
                    ...
                    getStringOrEmptyValue: function (t) {
                      for (var i = 0; i < t.length; i++) if ('string' == typeof t[i] && t[i]) return t[i];
                      return e
                    },
                      ...
                      3: [
                        function (t, e, i) {
                          ...
                          n.off = function (t, e) {
                            ...
                            n;
                            var i = s[t];
                            if (i) if (e) for (var a = i.length - 1; a >= 0; a--) i[a] === e && i.splice(a, 1);
                             else delete s[t];
                            return n
                          },
                          n.fire = function (t, e) {
                        ...
                        function (t, e, i) {
                          ...
                          e.exports = {
                            limit: function (t, e) {
                              ...
                              a = t.ret && t.ret[0];
                              a && a.indexOf('::') > - 1 && (a = a.split('::') [1], '流量限制' === a && (a = '哎呦喂，挤爆了！！')),
                            ...
                            antiCreep: function (t, e) {
                              ...
                              }), window.__sufeiSeed__ = sufei, void n.loadJS(s + '/app/common/sufei-caller.js', {
                              }, function () {
                        ...
                        function (t, e, i) {
                          ...
                          r = a.create({
                            ...
                            check: function (t, e) {
                              ...
                              return s.pass ? e(!0, t)  : t.url || 'limit' === s.interceptType ? (i.queue = i.queue || [
                              ], i.queue.push({
                                result: t,
                                fn: e
                          ...
                          f = {
                            loadJS: function (t, e, i) {
                              ...
                              if ('string' == typeof e) a.push(e);
                               else for (s in e) e.hasOwnProperty(s) && a.push(s + '=' + encodeURIComponent(e[s]));
                ...
                function (t, exports, e) {
                  ...
                  w = {
                    ...
                    f.default,
                    getOE() {
                      return this._OE || ('undefined' == typeof window ? this._OE = new a.default('', '') :
                      this._OE = new a.default(window.navigator.userAgent, window.location.search)),
                      this._OE
                    ...
                    unlisten: function (t) {
                      if (t) for (var e = this, i = e._getEventCallBackQueue(t.eventName), n = 0, s = i.length; n < s; n++) {
                        var a = i[n];
                    ...
                    invoke: function () {
                      ...
                      a = new Promise(function (a, o) {
                        n.OE.env.thirdapp.isYouku && n.OE.env.thirdapp.bridgeSdk || o(r.default.ENV_NOT_SUPPORTED); var l = void 0, d = void 0; u.default[s] && (l = u.default[s].ios,
                    ...
                    function (t, e) {
                      ...
                      for (var c in i) {
                        ...
                        h ? (h = !1, l = l + '?' + c + '=' + encodeURIComponent(f))  : l = l + '&' + c + '=' + encodeURIComponent(f)
                      }
                      ...
                      o = !!e,
                      r = void 0;
                      o ? (r = e.method, i = e.paramsTransformer ? e.paramsTransformer(i)  : {
                      })  : r = t;
                      var l = !o && n.callback;
                      if (l) {
                      ...
                      window[t] = function (e) {
                        return i.timer && (clearTimeout(i.timer), i.timer = null),
                        i.expired ? void (window[t] = null)  : (i.resolve(e), void (window[t] = null))
                      }
                    }
                  };
                  'undefined' != typeof window && (window.orbit = window.orbit || {
                  }, window.orbit.bridge = w, y = window.orbit, g = window.YoukuJSBridge, b = window.PlanetJSBridge),
                  exports.version = p,
                  exports.bridge = w
                }, function (t, exports, e) {
                  'use strict';
                  ...
                  function s() {
                    return new Promise(function (t, e) {
                      window.WindVane.call('WVTaobaoYoukuAccountJSBridge', 'queryBindingStatus', {
                      }, function (i) {
                        var n = i && i.data,
                        s = n && n.info ? n.info : n;
                        s.tuid ? t(s)  : e()
                    ...
                    a = new Promise(function (a, o) {
                      if (s.OE.env.thirdapp && s.OE.env.thirdapp.isWeixin) {
                        ...
                        'undefined' != typeof wx ? (wx.ready(function () {
                          t && (wx.onMenuShareAppMessage(t), wx.onMenuShareQQ(t), wx.onMenuShareWeibo(t), wx.onMenuShareQZone(t), wx.onMenuShareTimeline(t)),
                          a()
                        }), wx.error(function (t) {
                          o(t)
                        }), wx.config(l))  : o({
                ...
                function (t, exports, e) {
                  ...
                  (s = u.match(/AliApp\(([A-Z\-]+)\/([\d\.]+)\)/i)) && (d = !0, h = s[1], f = s[2], c = h.indexOf('-PD') > 0 ? l.default.isIOS ? 'iPad' : l.default.isAndroid ? 'AndroidPad' : l.default.name:
                  l.default.name),
                  !h && u.indexOf('TBIOS') > 0 && (h = 'TB');
                  var p = window._ua_popLayer || '',
                  m = !1,
                  v = '';
                  p && (s = p.match(/PopLayer\/([\d\.]+)/i)) && (m = !0, v = s[1]),
                  d && (d = {
                  ...
                  r.match(/IEMobile/) ? (n.name = 'IEMobile', n.isIEMobile = !0)  : (n.name = 'IE', n.isIE = !0),
                  ...
                  if (i) for (var n = i.split('&'), s = 0; s < n.length; s++) {
                    n[s] = n[s].split('=');
                    try {
                    ...
                    return s(t, [
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          l.default.addEventListenerHander(this._mediaElement, 'ended', this.e.onUnitEnd)) :
                          (l.default.addEventListenerHander(this._mediaElement, 'ended', this.e.onEnd),
                      ...
                      },
                      {
                        ...
                        value: function () {
                          if (this._mediaElement) return this._mediaElement.removeEventListener('timeupdate', this.e.onTimeupdate),
                          ...
                          'm3u8' === this.supportType ? void this._mediaElement.pause()  : void (this._mediaElement && (this._mediaElement.src = '', this._mediaElement.removeAttribute('src'), this._mediaElement = null))
                        }
                      },
                      {
                        key: 'on',
                        ...
                        value: function () {
                          if (!this._timer) {
                            ...
                            this._timer = setInterval(function () {
                              ...
                              this._mediaElement.play()), void (t._lastTime = t._mediaElement.currentTime))
                            },
                            3000)
                          }
                        }
                      },
                      {
                        ...
                        value: function () {
                          ...
                          !this._mediaElement) throw new IllegalStateException('HTMLMediaElement must be attached before load()!');
                          if (!this.addata) throw new IllegalStateException('adPlayer must be set adData and adtype'); var t = this.addata.VAL.length; return 0 === t ? (c.default.d(this.TAG, 'the length of addata is 0'),
                          void this.destroy()) : (this.currentTime = 0, this._pastTime = 0, this.curNum = 0, this._isEnd = !1, 'm3u8' === this.supportType ? (this.src = this.m3u8url, this.posiTime = this._mediaElement.currentTime || 0)  : (this.src = this.addata.VAL[this.curNum].RS, this.IE = this.addata.VAL[this.curNum].IE), void (this._mediaElement.readyState > 0 && (this._mediaElement.currentTime = 0)))
                        }
                      }, {
                        key: 'play',
                        value: function () {
                          ...
                          !this._isEnd) {
                            ...
                            if (this._firstTag) {
                              ...
                              this._mediaElement.addEventListener('canplay', function () {
                                1 !== e && (e = 1, c.default.i(i.TAG, 'canplay time=' + i.currentTime),
                                this.play())
                              })
                            }
                      ...
                      },
                      {
                        key: 'skip',
                        value: function (t) {
                          if (!(this._isEnd || t < 0 || 0 !== t && !t)) if (t < this.addata.VAL.length - 1) {
                            this.curNum = t + 1,
                            this._pastTime = 0;
                          ...
                          } else this.curNum = this.addata.VAL.length - 1,
                          ...
                          'm3u8' === this.supportType ? this._onUnitTimeUpdate(null)  : (this._mediaElement.pause(), this._ifEmitPause = !0, this._emitter.emit(o.default.AD_TIMEUPDATE,
                          null,
                          this.currentTime,
                          this.curNum), this._onEnd(null))
                        }
                      },
                      {
                        key: 'sendDotSUS',
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          this.curNum++,
                          this.curNum < this.addata.VAL.length ? (this._adreport.changeNum(this.curNum), this._mediaElement.pause(), this._ifEmitPause = !0, this._mediaElement.src = this.addata.VAL[this.curNum].RS, this._mediaElement.play())  : (c.default.i(this.TAG, '_adEnd:||this._isEnd:' + this._isEnd),
                          this._isEnd || (this._isEnd = !0, this.destroy(), this._adreport.sendAdLog(4, 400), this._adreport.sendAdGold({
                            p: 1,
                            code: 304
                          }, {
                            index: this.curnum
                          }), this._emitter.emit(o.default.AD_END,
                          t))))
                        }
                      }, {
                        key: '_onUnitEnd',
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          if (!this._isEnd && this._mediaElement) {
                            ...
                            this._emitter.emit(o.default.AD_TIMEUPDATE,
                            t,
                            this.currentTime,
                            this.curNum)
                          }
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          this._isEnd || this._mediaElement && (this.currentTime = this._mediaElement.currentTime, this.currentTime >= this.addata.totalTime ? (this._adreport.sendSUE(this.curNum), this._onUnitEnd(t))  : (this.currentTime > this._pastTime + this.addata.VAL[this.curNum].AL && (this._adreport.sendAdLog(3, 300, {
                            ...
                            index: this.curNum
                          }), this._pastTime += this.addata.VAL[this.curNum].AL, this._adreport.sendSUE(this.curNum), this.curNum++, this._adreport.sendSUS(this.curNum), this._adreport.changeNum(this.curNum)), this._emitter.emit(o.default.AD_TIMEUPDATE,
                          t,
                          this.currentTime,
                          this.curNum)))
                        }
                      },
                      {
                        key: '_onPlay',
                        value: function (t) {
                          this._isEnd || (this._firstTag && this._adreport.sendSUS(this.curNum), this._firstTag = !1, this._emitter.emit(o.default.AD_PLAY,
                          t))
                        }
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          void this._emitter.emit(o.default.AD_PAUSE,
                          t))
                        }
                      }, {
                        key: '_onError',
                        value: function (t) {
                          if (!this._isEnd) {
                            ...
                            'm3u8' === this.supportType ? (this._isEnd = !0, this._emitter.emit(o.default.AD_ERROR,
                            t)) : this.curNum < this.addata.VAL.length - 1 ? this.skip(this.curNum)  : (this._isEnd = !0, this._emitter.emit(o.default.AD_ERROR,
                            t))
                          }
                        }
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          !this._isEnd) {
                            ...
                            this._emitter.emit(o.default.AD_CANPLAY,
                            t)
                          }
                        }
                      },
                      {
                        key: '_onWaiting',
                        value: function (t) {
                          this._emitter.emit(o.default.AD_LOADING,
                          t)
                        }
                      },
                      {
                  ...
                  function (t, exports, e) {
                    ...
                    b = function () {
                      function t(e, i, s) {
                        ...
                        i.atoken && (this.param.ccode = i.ccode, this.param.atoken = i.atoken),
                        (s || i) && this.init(s, i),
                      ...
                      return s(t, [
                        ...
                        },
                        {
                          ...
                          value: function (t, e, i) {
                            if (e) {
                              if (e.m3u8_url && (this.m3u8url = e.m3u8_url), e.supportType && (this.supportType = e.supportType), e.ccode && (this.ccode = e.ccode), this.isAutoplay = !!e.autoplay, e.param) for (var n in e.param) this.param[n] = e.param[n];
                              if (e.adConfig) for (var s in e.adConfig) this.param[s] = e.adConfig[s];
                            ...
                            if (t) {
                              ...
                              for (var a = t.video.subcategories || [
                              ], o = [
                              ], l = 0, u = a.length; l < u; l++) o.push(a[l].id);
                              ...
                              this._setAdPoint(c),
                              i && (this.dots = this._createDotInfo(i), t.ups.pcad && this.parseFrontAd(i)),
                              t.ups.pcad || ('m3u8' === this.supportType ? (this.requestFrontAd(), this.requestEndAd())  : this.requestFrontAd())
                            }
                          }
                        },
                        {
                          ...
                          value: function () {
                            this._adplayer.off(m.default.AD_PLAY,
                            this.e.adPlay), this._adplayer.off(m.default.AD_PAUSE,
                            this.e.adPlayPause), this._adplayer.off(m.default.AD_END,
                            this.e.adPlayEnd), this._adplayer.off(m.default.AD_TIMEUPDATE,
                            this.e.adTimeUpdate), this._adplayer.off(m.default.AD_ERROR,
                            this.e.adPlayError), this._adplayer.off(m.default.AD_CANPLAY,
                            this.e.adCanPlay), this._adplayer.off(m.default.AD_LOADING,
                            this.e.adPlayLoading)
                          }
                        }, {
                          key: '_addAdplayerEmit',
                          value: function () {
                            this._adplayer.on(m.default.AD_PLAY,
                            this.e.adPlay), this._adplayer.on(m.default.AD_PAUSE,
                            this.e.adPlayPause), this._adplayer.on(m.default.AD_END,
                            this.e.adPlayEnd), this._adplayer.on(m.default.AD_TIMEUPDATE,
                            this.e.adTimeUpdate), this._adplayer.on(m.default.AD_ERROR,
                            this.e.adPlayError), this._adplayer.on(m.default.AD_CANPLAY,
                            this.e.adCanPlay), this._adplayer.on(m.default.AD_LOADING,
                            this.e.adPlayLoading)
                          }
                        }, {
                          key: 'on',
                          ...
                          value: function () {
                            ...
                            !this.addata) return void this._adplayEnd(null); var t = null; if (this.startplay) t = this._adplayer.play();  else {
                              if (!this.addata || 0 === this.addata.VAL.length) return u.default.d(this.TAG, 'play|||this.addata.VAL.length:' + this.addata.VAL.length),
                          ...
                          value: function () {
                            ...
                            r.default.checkVideoIsPaused(this._mediaElement)) return null;
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            if (this.contentNum < this._midpoints.length) {
                              var e = parseInt(this._midpoints[this.contentNum].start) / 1000;
                              if (e - t <= 5 && !this.netflag && !this.content_addata) return this.requestContentAd(),
                              !1;
                              if (t >= e) return !0
                            }
                            return !1
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this.addata && 0 !== this.addata.VAL.length ? (this._adplayer.setAdData(this.addata, this.m3u8url), void this._adReady(null))  : void this._adReady(null)
                          }
                        },
                        {
                          key: '_setAdPoint',
                          value: function (t) {
                            for (var e = [
                            ], i = 0, n = 0, s = 0, a = t.length; s < a; s++) 'standard' !== t[s].ctype && 'contentad' !== t[s].ctype || (t[s].num = 'standard' === t[s].ctype ? i++ : n++, e.push(t[s]));
                            this._midpoints = e
                          }
                        },
                        {
                        ...
                        },
                        {
                          key: '_checkRS',
                          value: function (t) {
                            for (var e = !1, i = y.length, n = 0; n < i; n++) if (t.indexOf(y[n]) > - 1) {
                              e = !0;
                              break
                            }
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            for (var l = t.VAL, u = 0; u < l.length; u++) 2 !== parseInt(l[u].VT) ? null != l[u].RS && '' != l[u].RS.trim() && null != l[u].VID && null != l[u].VQT && (a.VAL.push(l[u]), l[u].RS = r.default.changeProtocol(l[u].RS),
                            s.push(l[u].RS),
                            n.push(parseInt(l[u].AL)),
                            e += l[u].AL) : (l[u].pos_ = u - 1 - i.length, i.push(l[u])); return a.urls = s, a.seconds = n, a.vtvc = i, a.totalTime = e, a
                          }
                        },
                        {
                          key: '_createDotInfo',
                          value: function (t) {
                            ...
                            for (var i = t.BFVAL, n = [
                              ...
                              t.BFSTREAM && t.BFSTREAM[l.VID] && t.BFSTREAM[l.VID].preview && (u.thumb = t.BFSTREAM[l.VID].preview.thumb, u.timespan = t.BFSTREAM[l.VID].preview.timespan, d.thumb = t.BFSTREAM[l.VID].preview.thumb, d.timespan = t.BFSTREAM[l.VID].preview.timespan, d.start = u.start, d.end = u.end, s.push(d)),
                              n.push(u)
                            }
                            return e.dots = n,
                            e.count = n.length,
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            if (!this.front_addata) {
                              ...
                              this._emitter.emit(m.default.AD_DATA_OK,
                              this.front_addata,
                              this.adType), 'm3u8' === this.supportType) return void this.parseUnited();
                              this.addata = this.front_addata,
                              this._initAdPlayer()
                            }
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            'm3u8' === this.supportType ? void this.parseUnited()  : (this.addata = this.end_addata, this._emitter.emit(m.default.AD_DATA_OK,
                            this.end_addata,
                            this.adType), this._initAdPlayer(this.addata), u.default.i(this.TAG, 'parseEndAd(data)'),
                            void this.play())
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_DATA_OK,
                            this.content_addata,
                            this.adType), this.addata = this.content_addata
                          }
                        },
                        {
                          key: 'parsePauseAd',
                        ...
                        },
                        {
                          key: 'parseUnited',
                          value: function () {
                            this.unitedAd || this.front_addata && this.end_addata && (this.unitedAd = !0, u.default.i(this.TAG, 'parseUnited'),
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_DATA_ERROR,
                            this.adType)
                          }
                        },
                        {
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            i.pt = this._midpoints[this.contentNum].start / 1000;
                        ...
                        },
                        {
                          key: 'loadVTVC',
                          value: function (t) {
                            if (t) for (var e = 0; e < t.length; e++) r.default.loadfile(t[e].VC, 'js')
                          }
                        },
                        {
                          key: 'sendCUM',
                        ...
                        },
                        {
                          ...
                          value: function () {
                            ...
                            this.adType = a.AD_MAP.FRONT,
                            this.front_addata ? (this.addata = this.front_addata, this._initAdPlayer(this.addata), this.play())  : 'm3u8' === this.supportType ? (this.requestFrontAd(), this.requestEndAd())  : this.requestFrontAd(!0)
                          }
                        },
                        {
                          key: 'playEndAD',
                          value: function () {
                            this.adType = a.AD_MAP.END,
                            'm3u8' === this.supportType ? (this.addata = this.end_addata, this._emitter.emit(m.default.AD_DATA_OK,
                            this.end_addata,
                            this.adType), this._initAdPlayer(this.addata, !0), this.play()) : this.requestEndAd(!0)
                          }
                        },
                        {
                          key: 'playContentAd',
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_READY,
                            t,
                            this.adType)
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_ERROR,
                            t,
                            this.adType)
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_PLAY,
                            t,
                            this.adType)
                          }
                        },
                        {
                          ...
                          value: function (t, e, i) {
                            this._currentTime = e,
                            this._currentNum = i,
                            this._emitter.emit(m.default.AD_TIMEUPDATE,
                            t,
                            e,
                            this.adType,
                            i)
                        ...
                        },
                        {
                          ...
                          value: function (t, e) {
                            ...
                            this.adType === a.AD_MAP.FRONT && (this.frontAdTime = e || this.frontAdTime, u.default.i(this.TAG, '_adplayEnd(e):this..frontAdTime' + this.frontAdTime)), this.addata = null, this._emitter.emit(m.default.AD_END,
                            t,
                            this.adType), this._reset()
                          }
                        },
                        {
                          key: '_adplayPause',
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_PAUSE,
                            t,
                            this.adType)
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_LOADING,
                            t,
                            this.adType)
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            this._emitter.emit(m.default.AD_CANPLAY,
                            t,
                            this.adType)
                          }
                        },
                        {
                          ...
                          value: function (t) {
                            if (this.dots && this.dots.dots && this.dots.dots.length > 0) {
                              ...
                              i = - 1,
                              n = this.dots.index;
                              if (e > 0 && n === - 1) if (t < this.dots.dots[0].start || t > this.dots.dots[e - 1].end) i = - 1;
                        ...
                        },
                        {
                          ...
                          value: function (t, e) {
                            ...
                            for (var n = 0; n < i; n++) if (e > e > t[n].start && e > t[n].end) return n;
                            return - 1
                          }
                        }
                        ]),
                        ...
                        return s(t, [
                          ...
                          },
                          {
                            ...
                            value: function (t) {
                              ...
                              this._currentTime > 0 && (this._mediaElement.pause(), this.firstTime = this._currentTime + this._frontAdTime, this.seek(this.firstTime)),
                          ...
                          },
                          {
                            ...
                            value: function () {
                              if (this.m3u8Url && this._mediaElement) {
                                ...
                                this._mediaElement.src || (this._mediaElement.src = this.m3u8Url, t = this._mediaElement.play()),
                                t = this._mediaElement.play(),
                          ...
                          },
                          {
                            ...
                            value: function (t) {
                              this._ifEmitPause = !1,
                              this.adStatus || this._mediaElement.currentTime < this._frontAdTime || (this._firstflag && (this._firstflag = !1), this._emitter.emit(a.VIDEO_EVENTS.play, t))
                            }
                          },
                          {
                            key: '_onPause',
                            value: function (t) {
                              if (!(this.adStatus || this._mediaElement.currentTime < this._frontAdTime)) return this._ifEmitPause ? (u.default.d(this.TAG, '_onPause:_ifEmitPause' + this._ifEmitPause),
                          ...
                          },
                          {
                            ...
                            value: function (t) {
                              ...
                              this._mediaElement.play(),
                              this.firstTime = 0), this._emitter.emit(a.VIDEO_EVENTS.canplay, t))
                            }
                          },
                          {
                            key: '_onTimeupdate',
                            value: function (t) {
                              if (!(this.adStatus || this._mediaElement.currentTime < this._frontAdTime)) return this._currentTime = this._mediaElement.currentTime - this._frontAdTime,
                              this._currentTime >= this._totalTime ? (this._mediaElement.pause(), this._ifEmitPause = !0, u.default.i(this.TAG, 'trytime is out'),
                        ...
                        c = function () {
                          ...
                          return s(t, [
                            ...
                            },
                            {
                              key: 'load',
                              value: function (t) {
                                if (t) if (t.segs && (this._segs = t.segs), t.time && (this._currentTime = t.time), t.totalTime) this._totalTime = t.totalTime;
                                 else {
                                  this._totalTime = 0;
                            ...
                            },
                            {
                              key: 'play',
                              value: function (t) {
                                this._segs && 0 !== this._segs.length && this._mediaElement.paused && (t && (this._mediaElement.src = this._segs[this._curNum].cdn_url, this._mediaElement.currentTime = this._currentTime - this._pastTime), console.log('playVideoElementExclusion'), h.default.playVideoElementExclusion(this._mediaElement),
                                this._isPause = !1,
                                this._mediaElement.play())
                              }
                            },
                            ...
                            },
                            {
                              ...
                              value: function (t) {
                                ...
                                this._isPause = !0,
                                t ? void this.seek(t)  : (this._curNum = 0, this._pastTime = 0, this._currentTime = 0, this._mediaElement.src = this._segs[this._curNum].cdn_url, this._mediaElement.currentTime = this._currentTime - this._pastTime, void this._mediaElement.play())
                              }
                            },
                            {
                              key: '_seekMultiSeg',
                              value: function (t) {
                                var e = 0,
                                i = void 0;
                                if (i = 0 === t ? 0 : this._getCurNumBy(t), 0 === i ? (e = t, this._pastTime = 0)  : (this._pastTime = this._segs[i - 1].totalSegs_seconds_video, e = t - this._pastTime), u.default.i(this.TAG, '_num:' + i + ' _pastTime:' + this._pastTime + '  _vtTime:' + e),
                                i === this._curNum) {
                                  ...
                                  this._curNum = i,
                                  n ? (this._mediaElement.pause(), this._mediaElement.src = n, this._mediaElement.currentTime = e, this._setCurrentTime(e), this._mediaElement.play())  : this._mediaElement.pause()
                                }
                              }
                            },
                            {
                            ...
                            },
                            {
                              key: '_onEnd',
                              value: function (t) {
                                if (!this.adStatus) if (this._curNum++, this._curNum < this._segs.length) {
                                ...
                                } else u.default.i(this.TAG, '_onEnd' + this._curNum),
                                this._emitter.emit(a.VIDEO_EVENTS.ended, t)
                              }
                            },
                            {
                            ...
                            },
                            {
                              key: '_onTimeupdate',
                              value: function (t) {
                                if (!this.adStatus) return this._currentTime = this._mediaElement.currentTime + this._pastTime,
                                this._currentTime >= this._totalTime ? (u.default.i(this.TAG, 'trytime is out'),
                                this._mediaElement.pause(),
                                this._ifEmitPause = !0,
                                u.default.i(this.TAG, '_onEnd' + this._curNum),
                                void this._emitter.emit(a.VIDEO_EVENTS.ended, t)) :
                                void this._emitter.emit(a.VIDEO_EVENTS.timeupdate, t, this._currentTime)
                              }
                            },
                            {
                              key: '_onError',
                          ...
                          c = function () {
                            ...
                            return s(t, [
                              ...
                              },
                              {
                                key: '_initData',
                                value: function (t) {
                                  return this.destroyed ? void l.default.i(this.TAG, 'get ups info success destroyed block') :
                                  (l.default.i(this.TAG, 'get ups info success'),
                                  this.issuccess++,
                              ...
                              },
                              {
                                ...
                                value: function (t) {
                                  ...
                                  if (console.error(this.TAG, '_requestError' + this.iserror), !this.issuccess) {
                                    if (this.iserror++, t && 1111 === t.status) return this.iserror = 0,
                                    void this.error(t);
                                    if (this.iserror < this.tryCount && !this.issuccess) {
                                      this.ckey = o.default.getUA() ? o.default.getUA() :
                                      this.ckey,
                              ...
                              },
                              {
                                ...
                                value: function (t) {
                                  ...
                                  this.customData = t,
                                  this.customData && this.customParam.password && this.customData.passless && 1 === parseInt(this.customData.passless) ? (this.param.client_id = this.customParam.client_id, this.param.password = this.customParam.password)  : this.param.client_id ? delete this.param.client_id : '',
                                  this._getUpsData()
                                }
                              },
                              {
                              ...
                              },
                              {
                                ...
                                value: function () {
                                  //debugger;
                                  //this.param.ccode = "0510";
                                  var t = o.default.upstest ? o.default.upstest:
                                  h.UPS_API_URL;
                                  ...
                                  this.customData && this.customParam.atoken && (t += '&client_id=' + this.customParam.client_id, t += '&atoken=' + this.customParam.atoken),
                              ...
                              },
                              {
                                key: '_getUpsData',
                                value: function () {
                                  if (this.param.client_ts = parseInt((new Date).getTime() / 1000), this.param.utid ? this.utid = this.param.utid : this.utid = o.default.getCna(),
                              ...
                              },
                              {
                                key: 'start',
                                value: function (t, e, i, n, s) {
                                  if (this.error = e || this.error, this.callback = t || this.callback, this.timeout = i || function () {
                          ...
                          function (t, exports, e) {
                              ...
                              return s(t, [
                                ...
                                },
                                {
                                  ...
                                  value: function (t, e, i) {
                                    ...
                                    if (this.password = e, this.client_id = i, this._copyData(t), this.totalTime = this.video.seconds, this.video.title = o.default.htmlEncodeAll(this.video.title),
                                    this.show && (this.show.title = o.default.htmlEncodeAll(this.show.title)), this.encodeId = this.video.encodeid, this.videoId = this.video.id, this.stream && !(this.stream.length < 1)) {
                                      var n = {
                                        lang: '默认',
                                      ...
                                      for (var a = [
                                      ], r = 0, u = this.languageList.length; r < u; r++) a.push(this.languageList[r].langcode);
                                      this.langcodes = a,
                                      this.logo = {
                                      },
                                      this.waterInfo = {
                                  ...
                                  value: function (t, e) {
                                    ...
                                    for (var n = 0, s = e.length; n < s; n++) {
                                      ...
                                      for (var r = 0, l = t.length; r < l; r++) {
                                        for (var u = t[r], d = u.segs, h = 0, c = 0, f = 0, p = d.length; f < p; f++) d[f].seconds_audio = parseInt(d[f].total_milliseconds_audio) / 1000,
                                        d[f].seconds_video = parseInt(d[f].total_milliseconds_video) / 1000,
                                        h += parseInt(d[f].total_milliseconds_audio),
                                        c += parseInt(d[f].total_milliseconds_video),
                                        d[f].totalSegs_seconds_audio = h / 1000,
                                        d[f].totalSegs_seconds_video = c / 1000,
                                        d[f].cdn_url = o.default.changeProtocol(d[f].cdn_url);
                                        var m = void 0;
                                        t[r].audio_lang === a && (u.seconds_audio = u.milliseconds_audio / 1000, u.seconds_video = u.milliseconds_video / 1000, i[a][t[r].stream_type] ? (m = i[a][t[r].stream_type], m.seconds_video += u.seconds_video, m.seconds_audio += u.seconds_audio, m.size += u.size, m.segs = this._splicSegs(m.segs, u.segs), 'tail' === u.channel_type && (m.tailTime = u.seconds_video))  : (m = u, 'head' === m.channel_type ? m.headTime = u.seconds_video : m.headTime = 0, m.tailTime = 0, m.m3u8_url = this._checkM3u8(u.m3u8_url), this.logo[a][t[r].stream_type] = u.logo && 'none' !== u.logo ? 1 : 0), i[a][t[r].stream_type] = m)
                                      }
                                    }
                                    this.stream = i
                                  }
                                },
                                {
                                  ...
                                  value: function (t) {
                                    ...
                                    for (var e = 0; e < h.length; e++) if (t.indexOf(h[e]) > - 1) return !0;
                                    return !1
                                  }
                                },
                                {
                                ...
                                },
                                {
                                  ...
                                  value: function () {
                                    for (var t = {
                                    }, e = 0, i = this.langcodes.length; e < i; e++) {
                                      ...
                                      for (var a in d.SHOWHD_MAP) if (s[a] && ('3gphd' !== a || !s.mp4sd)) {
                                        var o = a;
                                        if (s[d.ACT_HD_MAP[a]]) {
                                          o = d.ACT_HD_MAP[a];
                                          break
                                ...
                                },
                                {
                                  key: '_dealWaterInfo',
                                  value: function () {
                                    if (this.watermark) for (var t = 0, e = this.watermark.length; t < e; t++) {
                                      ...
                                      1 !== i && 0 !== i && 4 !== i && 5 !== i || (1 === n ? this.waterInfo.logo.fullScreen = this.watermark[t] : 0 === n && (this.waterInfo.logo.normal = this.watermark[t])),
                                      3 === i && (1 === n ? this.waterInfo.license.fullScreen = this.watermark[t] : 0 === n && (this.waterInfo.license.normal = this.watermark[t])),
                                      2 === i && (1 === n ? this.waterInfo.register.fullScreen = this.watermark[t] : 0 === n && (this.waterInfo.register.normal = this.watermark[t]))
                                    }
                                  }
                                },
                                {
                                ...
                                },
                                {
                                  ...
                                  value: function () {
                                    ...
                                    return this.preview && (t.thumb = this.preview.thumb, t.timespan = this.preview.timespan),
                                    this.dvd && (t.head = this.dvd.head ? parseInt(this.dvd.head) / 1000 : 0, t.tail = this.dvd.tail ? parseInt(this.dvd.tail) / 1000 : 0, t.point = this.dvd.point),
                                    t
                                  }
                                },
                                {
                                  ...
                                  value: function () {
                                    ...
                                    this.cloud && (t.subtitle = this.cloud.player_var_subtitle, t.skip = this.cloud.player_skip_titles_credits, t.lang = this.cloud.player_language),
                                    t
                                  }
                                },
                                {
                                  ...
                                  value: function () {
                                    ...
                                    return this.user && (t.uid = this.user.uid, t.vip = this.user.vip, t.ip = this.user.ip, t.ytid = this.user.ytid),
                                    this.vip && (t.ad = this.vip.ad, t.acc_support = this.vip.acc_support, t.acc_pen = this.vip.acc_open, t.hd3 = this.vip.hd3, t.note = this.vip.note, t.reason = this.vip.reason, t.link = this.vip.link),
                                    t
                                  }
                                },
                                {
                                  ...
                                  value: function () {
                                    ...
                                    return this.pay && (t.can_play = this.pay.can_play, t.h5_caseurl = this.pay.h5_caseurl, t.price = this.pay.price, t.discount_price = this.pay.discount_price, t.duration = this.pay.duration),
                                    this.fee && (t.ad = this.fee.ad, t.paidType = this.fee.paid_type, t.ownChannelId = this.fee.own_channel_id, t.paid = this.fee.paid, t.videoType = this.fee.video_type),
                                    this.vipPayInfo && (t.vipPayInfo = this.vipPayInfo),
                                    t
                                  }
                                },
                                {
                            ...
                            function (t, exports, e) {
                              ...
                              g = function () {
                                ...
                                return s(t, [
                                  ...
                                  },
                                  {
                                    key: 'changeParam',
                                    value: function (t) {
                                      if (t) for (var e in t) this[e] = t[e]
                                    }
                                  },
                                  {
                                    key: 'sendTSLog',
                                    value: function (t) {
                                      ...
                                      if (this.tstimer = setTimeout(function (t) {
                                        i.sendTSLog(60)
                                      }, 1000 * e), (61 === t || this._player.error) && (h.default.i(this.TAG, '播放结束times：' + t),
                                      clearTimeout(this.tstimer),
                                      this.tstimer = null), this._player.currentState === u.YKP.PLAYER_STATE.PLAYING && !this._mediaElement.paused) {
                                        ...
                                        n.r = this._signTS(a),
                                        this._isThirdParty && (n.clientid = this.client_id, n.type = 'h5');
                                        var r = '';
                                  ...
                                  },
                                  {
                                    ...
                                    value: function () {
                                      ...
                                      this.tsClb = 0,
                                      this.dClb = 0,
                                      this.drtimer && (clearInterval(this.drtimer), this.drtimer = null)
                                    }
                                  },
                                  {
                                    key: 'initAdInfo',
                                  ...
                                  },
                                  {
                                    key: 'initBFAdIndos',
                                    value: function () {
                                      if (this._player._adplugin && this._player._adplugin.dots && this._player._adplugin.dots.dots && this._player._adplugin.dots.dots.length > 0 && '' === this._ad_infos) for (var t = this._player._adplugin.dots.dots, e = 0; e < t.length; e++) {
                                        var i = t[e];
                                  ...
                                  },
                                  {
                                    ...
                                    value: function (t) {
                                      if (this._videoInfo) {
                                        ...
                                        1 === this.pubParam.Type && (e.fid = this.pubParam.playListId, e.fct = this.pubParam.playListChannelId, e.fcs = this.pubParam.fcs, e.folderOwnerId = this.pubParam.folderOwnerId, e.fob = this.pubParam.fob, e.fpo = this.pubParam.fpo),
                                        ...
                                        '' !== a && (s += '&' + o.default.urlParameter(this.vvlogextParam)); try {
                                  ...
                                  },
                                  {
                                    ...
                                    value: function (t, e, i, n) {
                                      ...
                                      s.x = o.default.encode64(o.default.urlParameter(a)), s.cna = this.cna; o.default.urlParameter(s);
                                      if ('xenfs' == t || 'xexfs' == t) {
                                        this._giveupReTag = !0;
                                        var u = this;
                                        setTimeout(function (t) {
                                      ...
                                      try {
                                        this.vvlogext || (this.vvlogext = UrchinAplus._yVvlogInfo() || ''),
                                        this.vvlogext && (s.pc_i = this.vvlogext.pc_i, s.pc_u = this.vvlogext.pc_u)
                                      } catch (t) {
                                      }
                                      s.url = n || '',
                                  ...
                                  },
                                  {
                                    ...
                                    value: function () {
                                      var t = 'H',
                                      e = (new Date).getTime() + '';
                                      return t += Math.round(10000000000 * Math.random()),
                                      t += e.substr(7, 12)
                                    }
                                  },
                                  {
                                    ...
                                    value: function (t) {
                                      if (0 !== this.pubParam.uid || 1 !== t) {
                                        var e = {
                                          ...
                                          po: Math.round(1000 * this._player.currentTime) || '0',
                                          hwclass: 4,
                                          devicename: 'H5',
                                          mt: '1',
                                        ...
                                        i && (e.shid = i.encodeid, e.tp = i.video_type, e.cg = i.showcategory, e.stg = i.stage),
                                  ...
                                  },
                                  {
                                    ...
                                    value: function () {
                                      if (this._videoInfo) {
                                        this._videoInfo.user ? (this.pubParam.uid = this._videoInfo.user.ytid || this._videoInfo.user.uid || 0, this.pubParam.isvip = this._videoInfo.user.vip ? 1 : 0)  : (this.pubParam.uid = 0, this.pubParam.isvip = 0),
                                  ...
                                  },
                                  {
                                    ...
                                    value: function (t) {
                                      ...
                                      i = 0,
                                      n = t.length;
                                      for (e = 0; e < n; e++) i = 43 * i + t.charCodeAt(e),
                                      i %= 10000000000;
                                      return i
                                    }
                                  },
                              ...
                              function (t, exports) {
                                ...
                                function e(t) {
                                  ...
                                  var g = t.length,
                                  b = new Array;
                                  for (a = 0; a < g - 3; a += 4) o = t.charCodeAt(a) << 24 | t.charCodeAt(a + 1) << 16 | t.charCodeAt(a + 2) << 8 | t.charCodeAt(a + 3),
                                  b.push(o);
                                  switch (g % 4) {
                                    case 0:
                                      a = 2147483648;
                                  ...
                                  for (b.push(g >>> 29), b.push(g << 3 & 4294967295), s = 0; s < b.length; s += 16) {
                                    ...
                                    for (r = p, l = m, u = v, d = _, h = y, a = 0; a <= 19; a++) c = e(r, 5) + (l & u | ~l & d) + h + f[a] + 1518500249 & 4294967295,
                                    h = d,
                                    d = u,
                                    u = e(l, 30),
                                    l = r,
                                    r = c;
                                    for (a = 20; a <= 39; a++) c = e(r, 5) + (l ^ u ^ d) + h + f[a] + 1859775393 & 4294967295,
                                    h = d,
                                    d = u,
                                    u = e(l, 30),
                                    l = r,
                                    r = c;
                                    for (a = 40; a <= 59; a++) c = e(r, 5) + (l & u | l & d | u & d) + h + f[a] + 2400959708 & 4294967295,
                                    h = d,
                                    d = u,
                                    u = e(l, 30),
                                    l = r,
                                    r = c;
                                    for (a = 60; a <= 79; a++) c = e(r, 5) + (l ^ u ^ d) + h + f[a] + 3395469782 & 4294967295,
                                    h = d,
                                    d = u,
                                    u = e(l, 30),
                                    l = r,
                            ...
                            function (t, exports, e) {
                              ...
                              YKPlayer.Player = function (t, e, i) {
                                ...
                                s.appendChild(o),
                                e.vid && (e.videoId = e.vid, delete e.vid),
                            ...
                            function (t, exports) {
                              ...
                              function i(t) {
                                try {
                                  ...
                                  for (var i = t.match(a), n = 1; n < i.length; n++) t = e(i, n).join(''),
                                  i = t.match(a);
                                  return t
                                }
                              }
	...
	*/
                            ...
                            function (t, exports) {
                              ...
                              function n(t) {
                                ...
                                if ((u === e || !u) && setTimeout) return u = setTimeout,
                                setTimeout(t, 0);
                                try {
                                  return u(t, 0)
                                } catch (e) {
                                ...
                                switch (t.arrayFormat) {
                                  ...
                                  case 'bracket':
                                    return function (t, i, n) {
                                      return e = /(\[\])$/.exec(t),
                                      t = t.replace(/\[\]$/, ''),
                                      e ? void 0 === n[t] ? void (n[t] = [
                                        i
                                      ])  : void (n[t] = [
                                      ].concat(n[t], i))  : void (n[t] = i)
                                    };
                                  default:
                                    return function (t, e, i) {
                                      return void 0 === i[t] ? void (i[t] = e)  : void (i[t] = [
                                      ].concat(i[t], e))
                                    }
                                }
                              }
                              ...
                              (function (t, e) {
                                !function (t, i) {
                                  ...
                                  if (!t.setImmediate) {
                                    ...
                                    '[object process]' === {
                                    }.toString.call(t.process) ? r()  : l() ? u()  : t.MessageChannel ? d()  : _ && 'onreadystatechange' in _.createElement('script') ? h()  : c(),
                                    y.setImmediate = n,
                                    y.clearImmediate = s
                                  }
                            ...
                            function (t, exports) {
                              !function (t) {
                                ...
                                function h() {
                                  ...
                                  this._initBody = function (t) {
                                    if (this._bodyInit = t, t) if ('string' == typeof t) this._bodyText = t;
                                     ...
                                     else if (_.arrayBuffer && _.blob && g(t)) this._bodyArrayBuffer = d(t.buffer),
                                ...
                                function f(t, e) {
                                  ...
                                  if (this.credentials = e.credentials || this.credentials || 'omit', !e.headers && this.headers || (this.headers = new s(e.headers)), this.method = c(e.method || this.method || 'GET'), this.mode = e.mode || this.mode || null, this.referrer = null, ('GET' === this.method || 'HEAD' === this.method) && i) throw new TypeError('Body not allowed for GET or HEAD requests');
                                  this._initBody(i)
                                }
                                function p(t) {
                                  var e = new FormData;
