/*! Txplayer - v3.0.0 - 2020-01-16 21:47:14
 * Copyright (c) 2020
        ...
        d.prototype = {
            init: function () {
                ...
                if ("all" === a)
                    ...
                    b.dataset.$container && "function" === Txplayer.$.type(b.dataset.$container.animate) ? b.dataset.$container.animate({
                        height: 0
                    }, 300, function () {
    ...
    0: function (a, b, c) {
        ...
        d.prototype = {
            init: function () {
                ...
                }), this.context.msg.on("play", this.play.bind(this)),
                this.context.msg.on("pause", this.pause.bind(this)),
                this.context.msg.on("playTheNext", this.playTheNext.bind(this)), 
                this.context.msg.on("clearFocusVideoUrl", this.clearFocusVideoUrl.bind(this)), 
                this.context.msg.on("videoRequestFullScreen", this.videoRequestFullScreen.bind(this)), 
                this.context.msg.on("videoExitFullScreen", this.videoExitFullScreen.bind(this)), 
                this.context.msg.on("setFocusVideoCurrentTime", this.setFocusVideoCurrentTime.bind(this)), 
                this.context.msg.on("qqNewsHack", this.qqNewsHack.bind(this)), 
                this.context.msg.on("androidHack", this.androidHack.bind(this))
            }, exportsModuleApis: function () {
                var a = this;
    ...
    0: function (a, b, c) {
        ...
        d.prototype = {
            init: function () {
                ...
                this.context.$mod.$playermod.append(c), this.dataset.$definitionLayer = this.context.$mod.$playermod.find('[data-role="' + a.definitionLayer + '"]'), this.dataset.$hdDownloadBanner = this.context.$mod.$playermod.find('[data-role="' + a.definitionOpenapp + '"]'), this.hideLayer()
                ...
                var a = this;
                this.dataset.$hdDownloadBanner.on("click", function () {
                    return a.context.config.bannerEvent ? void(window[a.context.config.bannerEvent] && window[a.context.config.bannerEvent]()) : (a.context.dataset.hdClicked = !0, a.context.msg.broadcast("bannerClick", {
                ...
                a.context.msg.on("appChecked", function (b) {
                    ...
                    a.dataset.downloadState = b, b && a.changeStatus(b)
                }), this.dataset.$definitionBtn.on(Txplayer.dataset.clickEventName, function () {
                    a.stepReport(a.dataset.downloadState), a.showLayer(), a.dataset.hideHdTimeout && clearTimeout(a.dataset.hideHdTimeout), a.dataset.hideHdTimeout = setTimeout(function () {
                        a.hideLayer()
                    }, 3e3)
