...
! function (a) {
    ...
    0: function (a, b, c) {
        ...
        d.prototype = {
            init: function () {
                this.dataset.browserFullscreenClass = "txp_fullscreen_mode", this.context.dataset.isWindowFullscreen = !1, this.context.dataset.isBrowserFullscreen = !1, this.dataset.isFakeFullsreen = !e.os.ios && window.top == window && this.context.config.isHtml5UseFakeFullScreen, this.write(), this.addEventListerner(), this.exportsModuleApis(), g(this)
            }, write: function () {
                var a = {
                ...
                this.context.msg.broadcast("enterBrowserFullscreen"), a.context.$mod.$playermod.addClass(a.dataset.browserFullscreenClass), a.dataset.$fullscreenBtn.attr("data-status", "true"), a.context.dataset.isBrowserFullscreen = !0, a.context.msg.broadcast("screenChange", !0, !0), a.context.msg.broadcast("resize", {
                    height: a.context.$mod.$playermod.height(),
                    width: a.context.$mod.$playermod.width()
                })
            }, exitBrowserFullscreen: function (a) {
                var b = this;
                this.context.msg.broadcast("exitBrowserFullscreen"), b.context.$mod.$playermod.removeClass(b.dataset.browserFullscreenClass), b.dataset.$fullscreenBtn.attr("data-status", !1), b.context.dataset.isBrowserFullscreen = !1, b.context.msg.broadcast("screenChange", !0, !1), b.context.msg.broadcast("resize", {
                    height: b.context.$mod.$playermod.height(),
                    width: b.context.$mod.$playermod.width()
                })
                ...
                this.dataset.$fullscreenBtn.on(Txplayer.dataset.clickEventName, function () {
                    ...
                    b ? a.context.userMsg.broadcast("browserFullscreenChange", c) : a.context.userMsg.broadcast("windowFullscreenChange", c)
                }), this.context.msg.on("videoEnd", function (b) {
                    b && b.isAllEnd && (a.context.dataset.isWindowFullscreen ? a.exitWindowFullscreen() : a.context.dataset.isBrowserFullscreen && a.exitBrowserFullscreen())
                })
...
! function (a) {
    ...
    0: function (a, b, c) {
        ...
        var AppHelper = {},
            ...
            appConfig = {
                qqlive: {
                    md5Cgi: "//mcgi.v.qq.com/commdatav2?cmd=39&otype=json&confid=${id}",
            ...
            init: function () {
                ...
                if (!this.dataset.loadingAdError) {
                    ...
                    if (1 !== this.context.dataset.playState && !this.context.dataset.isPlayingAd || !(a === this.context.dataset.vid || a && a.vid === this.context.dataset.vid)) {
                        ...
                        if ("string" === f.type(a) ? a = {
                            vid: a,
                            autoplay: !0
                        } : ("object" === f.type(a) && !a.vid || "undefined" === f.type(a)) && (a || (a = {}), a.autoplay = !0), a.hasOwnProperty("vid") && this.setVid(a.vid), a.hasOwnProperty("cid") && (this.context.dataset.cid = a.cid), a.hasOwnProperty("columnId") && (this.dataset.columnId = a.columnId), a.hasOwnProperty("autoplay") && (this.context.dataset.autoplay = a.autoplay), a.hasOwnProperty("isNeedPay") && (this.dataset.isNeedPay = a.isNeedPay), a.hasOwnProperty("title") && (this.context.dataset.title = g.xss(a.title)), a.hasOwnProperty("playEndTime") && a.playEndTime && a.hasOwnProperty("duration")) {
                            var d = parseInt(a.duration) - parseInt(a.playEndTime);
                            this.context.dataset.playEndTime = d < 0 ? null : d
                        }
                        this.context.dataset.playStartTime = a.playStartTime ? a.playStartTime : 0, this.context.dataset.connectionPlayType = a.hasOwnProperty("connectionPlayType") ? a.connectionPlayType : 0, this.dataset.hasVideoPlayed = !1, this.context.msg.broadcast("playerReInit"), this.context.msg.broadcast("beforeVideoPlay"), this.context.dataset.hasOwnProperty("isPlayingAd") || (g.log("\u6ca1\u6709\u5e7f\u544a\u63d2\u4ef6"), c.dataset.hasAdPluginCheck || c.context.config.disableAdBlock ? c.loadVideoUrls({
        ...
        var e = Txplayer.$,
            ...
            h = [{
                ...
                reg: function () {
                    return !(!this.cfg.eduext && !this.cfg.authext)
                }, request: function (a) {
                    var b = this;
                    a.resolve({
                        cgi: c("edugetvinfo"),
...
! function (a) {
    ...
    0: function (a, b, c) {
        ...
        d.prototype = {
            getLimit: function () {
                var a = this;
                this.context.dataset.isLimit ? a.init() : this.context.msg.on("limitInitStart", function () {
                    a.context.dataset.isLimit && a.init()
                })
            }, init: function () {
                this.context.dataset.isNeedPay || (this.dataset.reportPromotionId = "859", this.dataset.downloadState = 1, this.dataset.reported = !1, this.context.dataset.fullBannerShowed = !1, this.write(), this.addEventListener(), this.exportsModuleApis())
            }, write: function () {
                var a = {
                    hideClass: Txplayer.dataset.hideClass,
                    fullBtn: "txp-h5-ui-fullbtn"
                };
                this.dataset.renderData = a;
                var b = Txplayer.$.tmpl(f, a);
                ...
                var a = this;
                this.dataset.$fullBtn.on("click", function () {
                    return a.context.config.bannerEvent ? void(window[a.context.config.bannerEvent] && window[a.context.config.bannerEvent]()) : (a.context.msg.broadcast("bannerClick", {
                        reportPromotionId: a.dataset.reportPromotionId,
                        vid: a.context.dataset.vid,
                        openUrl: a.context.config.openUrl || ""
                    }), void a.context.msg.broadcast("setTopReportId", a.dataset.reportPromotionId))
                })
            }, stepReport: function (a, b) {
                var c = {
                    vid: this.context.dataset.vid,
                ...
                var a = this;
                Txplayer.dataset.hasApp ? a.updateBanner(Txplayer.dataset.hasApp) : a.context.msg.on("appChecked", function (b) {
                    a.updateBanner(b)
                }), a.context.msg.on("bannerDownloadStateChange", function (b) {
                    a.dataset.downloadState = b, 1 == a.dataset.downloadState && "film" == a.context.dataset.currentPlayListType && a.context.dataset.playState != -1 && a.show()
                })
            }, exportsModuleApis: function () {
                var a = this;
